...
const I01Page = () => {
  return (
    <>
      <Column className="bg-white_A700 font-pingfangsc items-center justify-start mx-[auto] lg:pb-[55px] xl:pb-[69px] 2xl:pb-[78px] 3xl:pb-[93px] w-[100%]">
        <Column className="items-center justify-start w-[100%]">
          ...
          <Column className="justify-start w-[100%]">
                ...
                <Column className="items-center justify-start w-[100%]">
                  <Column className="items-center justify-start w-[97%]">
                    ...
                    <Row className="items-center justify-between lg:mt-[18px] xl:mt-[23px] 2xl:mt-[26px] 3xl:mt-[31px] w-[100%]">
                      <Row className="items-start w-[13%]">
            ...
            <Column className="bg-gradient2  border border-gray_202 border-solid justify-center lg:ml-[22px] xl:ml-[28px] 2xl:ml-[32px] 3xl:ml-[38px] lg:mt-[15px] xl:mt-[19px] 2xl:mt-[22px] 3xl:mt-[26px] lg:p-[17px] xl:p-[21px] 2xl:p-[24px] 3xl:p-[28px] rounded-radius8 w-[58%]">
              <Column className="items-center justify-start lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] w-[27%]">
                <Text
              ...
              <Row className="items-center lg:mb-[4px] xl:mb-[6px] 2xl:mb-[7px] 3xl:mb-[8px] lg:mt-[15px] xl:mt-[19px] 2xl:mt-[22px] 3xl:mt-[26px] w-[21%]">
                ...
                <Text
                  className="2xl:ml-[10px] 3xl:ml-[12px] lg:ml-[7px] xl:ml-[8px] columnu1230"
                  variant="body8"
                >
                  行人、车辆、行人+车辆
                </Text>
            ...
            <Row className="items-start justify-between lg:ml-[22px] xl:ml-[28px] 2xl:ml-[32px] 3xl:ml-[38px] lg:mt-[28px] xl:mt-[35px] 2xl:mt-[40px] 3xl:mt-[48px] w-[98%]">
                                ...
                                <Stack className="absolute lg:h-[277px] xl:h-[347px] 2xl:h-[390px] 3xl:h-[468px] top-[0] w-[100%]">
                                  <Stack className="absolute lg:h-[277px] xl:h-[347px] 2xl:h-[390px] 3xl:h-[468px] w-[100%]">
                                    <Stack className="absolute lg:h-[277px] xl:h-[347px] 2xl:h-[390px] 3xl:h-[468px] w-[100%]">
                                      ...
                                      <Text
                                        className="absolute right-[25%] top-[6%] columnu1230"
                                        variant="body9"
                                      >
                                        05:23
                                      </Text>
                                      ...
                                      <Text
                                        className="absolute right-[36%] top-[6%] columnu1230"
                                        variant="body9"
                                      >
                                        2020-09-09 21:00:02
                                      </Text>
              ...
              <Line className="bg-gray_205 xl:h-[114px] 2xl:h-[129px] 3xl:h-[154px] lg:h-[92px] lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] rounded-radius3 w-[6px]" />
            </Row>
          </Column>
        </Column>
      </Column>

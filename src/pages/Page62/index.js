...
const Page62 = () => {
  return (
    <>
      <Column className="bg-white_A700 font-pingfangsc items-center justify-start mx-[auto] lg:pb-[22px] xl:pb-[27px] 2xl:pb-[31px] 3xl:pb-[37px] w-[100%]">
        <Column className="items-center justify-start w-[100%]">
          <Stack className="lg:h-[159px] xl:h-[199px] 2xl:h-[224px] 3xl:h-[268px] w-[100%]">
            <Stack className="bottom-[0] test_20220825">
              <Stack className="absolute lg:h-[114px] xl:h-[143px] 2xl:h-[161px] 3xl:h-[193px] right-[0] w-[87%]">
                <Img
                  src="images/img_image1_48.png"
                  className="imageOne"
                  alt="imageOne"
                />
                <Img
                  src="images/img_20220825_47.png"
          ...
          <Column className="justify-start lg:mt-[28px] xl:mt-[35px] 2xl:mt-[40px] 3xl:mt-[48px] w-[97%]">
            ...
            <Column className="bg-gray_54 justify-start xl:ml-[113px] 2xl:ml-[128px] 3xl:ml-[153px] lg:ml-[91px] lg:mt-[19px] xl:mt-[24px] 2xl:mt-[28px] 3xl:mt-[33px] lg:p-[14px] xl:p-[17px] 2xl:p-[20px] 3xl:p-[24px] rounded-radius8 w-[90%]">
              <Column className="justify-start 2xl:my-[10px] 3xl:my-[12px] lg:my-[7px] xl:my-[8px] w-[75%]">
                <Row className="items-center w-[52%]">
                  ...
                  <Text
                    className="lg:ml-[30px] xl:ml-[38px] 2xl:ml-[43px] 3xl:ml-[51px] tips_Three"
                    variant="body8"
                  >
                    油门失效、刹车失效、刹车响应延迟
                  </Text>
            ...
            <Line className="bg-gray_201 h-[1px] lg:mt-[45px] xl:mt-[56px] 2xl:mt-[64px] 3xl:mt-[76px] rounded-radius05 w-[99%]" />
            <Row className="items-start justify-between lg:mt-[48px] xl:mt-[60px] 2xl:mt-[68px] 3xl:mt-[81px] w-[100%]">
              <Column className="justify-start w-[99%]">
                ...
                <Column className="bg-gray_54 items-center justify-end lg:mt-[19px] xl:mt-[24px] 2xl:mt-[28px] 3xl:mt-[33px] lg:p-[22px] xl:p-[28px] 2xl:p-[32px] 3xl:p-[38px] rounded-radius8 w-[100%]">
                  <Column className="items-center justify-start mt-[4px] w-[100%]">
                    <Column className="bg-white_A700 items-center justify-end lg:p-[22px] xl:p-[27px] 2xl:p-[31px] 3xl:p-[37px] rounded-radius8 w-[100%]">
                      <Column className="justify-start lg:mt-[4px] xl:mt-[6px] 2xl:mt-[7px] 3xl:mt-[8px] w-[100%]">
                        ...
                        <Row className="font-alibabapuhuiti items-start justify-between lg:mt-[32px] xl:mt-[40px] 2xl:mt-[46px] 3xl:mt-[55px] w-[100%]">
                          <Column className="justify-start 3xl:mt-[10px] lg:mt-[6px] xl:mt-[8px] 2xl:mt-[9px] w-[7%]">
                            <Text
                            ...
                            <Text className="BO" variant="body4">
                              BO
                            </Text>
                            <Text
                              className="font-bold 2xl:mt-[100px] 3xl:mt-[120px] lg:mt-[71px] xl:mt-[88px] text-bluegray_800 w-[auto]"
                              variant="body4"
                            >
                              Halton
                            </Text>
                          ...
                          <Column className="justify-start w-[91%]">
                            <Row className="items-center justify-between w-[100%]">
                              <Column className="items-end w-[13%]">
                                <Column className="items-end justify-start w-[79%]">
                                  <Text
                                    className="font-normal text-bluegray_500 w-[auto]"
                                    variant="body9"
                                  >
                                    SA-relative_distance
                                  </Text>
                                  <Text
                                    className="columnhaltonrelative"
                                    variant="body9"
                                  >
                                    SA-npc_speed
                                  </Text>
                                  <Text
                                    className="font-normal lg:mt-[19px] xl:mt-[24px] 2xl:mt-[28px] 3xl:mt-[33px] text-bluegray_500 w-[auto]"
                                    variant="body9"
                                  >
                                    SA-npc_start_s
                                  </Text>
                                ...
                                <Text
                                  ...
                                  variant="body9"
                                >
                                  Halton-relative_distance
                                </Text>
                                <Column className="items-center justify-start lg:mt-[17px] xl:mt-[22px] 2xl:mt-[25px] 3xl:mt-[30px] w-[72%]">
                                  <Text
                                    className="font-normal text-bluegray_500 w-[auto]"
                                    variant="body9"
                                  >
                                ...
                                <Text
                                  ...
                                  variant="body9"
                                >
                                  Random-relative_distance
                                </Text>
                                <Column className="justify-start lg:mt-[17px] xl:mt-[22px] 2xl:mt-[25px] 3xl:mt-[30px] w-[79%]">
                                  <Text
                                    className="font-normal ml-[3px] text-bluegray_500 w-[auto]"
                                    variant="body9"
                                  >
                                    Random-npc_speed
                                  </Text>
                                  ...
                                  <Text
                                    className="ml-[3px] columnhaltonrelative"
                                    variant="body9"
                                  >
                                    CE-relative_distance
                                  </Text>
                                  <Text
                                    className="lg:ml-[27px] xl:ml-[33px] 2xl:ml-[38px] 3xl:ml-[45px] columnhaltonrelative"
                                    variant="body9"
                                  >
                                    CE-npc_speed
                                  </Text>
                                  <Text
                                    className="font-normal lg:ml-[24px] xl:ml-[31px] 2xl:ml-[35px] 3xl:ml-[42px] lg:mt-[20px] xl:mt-[25px] 2xl:mt-[29px] 3xl:mt-[34px] text-bluegray_500 w-[auto]"
                                    variant="body9"
                                  >
                                    CE-npc_start_s
                                  </Text>
                              ...
                              <Column
                                className="bg-cover bg-repeat items-center xl:p-[11px] 2xl:p-[13px] 3xl:p-[15px] lg:p-[9px] rounded-radius2 w-[86%]"
                                style={{
                                  backgroundImage:
                                    "url('images/img_group2264.svg')",
                                }}
                              >
                                <List
                                ...
                                >
                                  <Row className="items-center justify-between mx-[auto] xl:my-[12px] 2xl:my-[13px] 3xl:my-[16px] lg:my-[9px] w-[99%]">
                                    <Text
                                      className="rowoverline"
                                      variant="body9"
                                    >
                                      68
                                    </Text>
                                  ...
                                  <Row className="items-center justify-between lg:ml-[4px] xl:ml-[6px] 2xl:ml-[7px] 3xl:ml-[8px] mr-[4px] xl:my-[12px] 2xl:my-[13px] 3xl:my-[16px] lg:my-[9px] w-[99%]">
                                    <Text
                                      className="OVERLINE_One"
                                      variant="body9"
                                    >
                                      5
                                    </Text>
                                    <Text
                                      className="OVERLINE_One_One"
                                      variant="body9"
                                    >
                                      25
                                    </Text>
                                  ...
                                  <Row className="items-center justify-between lg:mr-[4px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[8px] xl:my-[12px] 2xl:my-[13px] 3xl:my-[16px] lg:my-[9px] w-[99%]">
                                    <Text
                                      className="OVERLINE_Three"
                                      variant="body9"
                                    >
                                      107
                                    </Text>
                                  ...
                                  <Row className="items-center justify-between mx-[auto] xl:my-[12px] 2xl:my-[13px] 3xl:my-[16px] lg:my-[9px] w-[98%]">
                                    <Text
                                      className="OVERLINE_One"
                                      variant="body9"
                                    >
                                  ...
                                  <Row className="items-center justify-between xl:my-[12px] 2xl:my-[13px] 3xl:my-[16px] lg:my-[9px] w-[100%]">
                                    <Text
                                      className="OVERLINE_Three"
                                      variant="body9"
                                    >
                                  ...
                                  <Row className="items-center justify-between lg:ml-[4px] xl:ml-[6px] 2xl:ml-[7px] 3xl:ml-[8px] xl:my-[12px] 2xl:my-[13px] 3xl:my-[16px] lg:my-[9px] w-[99%]">
                                    <Text
                                      className="OVERLINE_One"
                                      variant="body9"
                                    >
                            ...
                            <Row className="items-center justify-end ml-[auto] xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[15px] lg:mt-[9px] w-[79%]">
                              <Text
                                className="font-normal text-bluegray_500 uppercase w-[auto]"
                                variant="body9"
                              >
                                1p
                              </Text>
                              <Text
                                className="font-normal lg:ml-[55px] xl:ml-[69px] 2xl:ml-[78px] 3xl:ml-[93px] text-bluegray_500 uppercase w-[auto]"
                                variant="body9"
                              >
                                2p
                              </Text>
                              <Text
                                className="font-normal 3xl:ml-[103px] lg:ml-[61px] xl:ml-[76px] 2xl:ml-[86px] text-bluegray_500 uppercase w-[auto]"
                                variant="body9"
                              >
                                3p
                              </Text>
                              <Text
                                className="OVERLINE_Eighteen"
                                variant="body9"
                              >
                                4p
                              </Text>
                              ...
                              <Text
                                className="font-normal lg:ml-[56px] xl:ml-[70px] 2xl:ml-[79px] 3xl:ml-[94px] text-bluegray_500 uppercase w-[auto]"
                                variant="body9"
                              >
                                10p
                              </Text>
                    ...
                    <List
                      ...
                      orientation="vertical"
                    >
                      <Column className="bg-white_A700 items-center justify-end xl:my-[10px] 2xl:my-[12px] 3xl:my-[14px] lg:my-[8px] lg:p-[22px] xl:p-[28px] 2xl:p-[32px] 3xl:p-[38px] rounded-radius8 w-[100%]">
                        <Column className="justify-start lg:mt-[4px] xl:mt-[6px] 2xl:mt-[7px] 3xl:mt-[8px] w-[100%]">
                          <Text
                            className="font-semibold text-bluegray_800 w-[auto]"
                            as="h5"
                          ...
                          <Row className="items-center lg:mt-[32px] xl:mt-[40px] 2xl:mt-[46px] 3xl:mt-[55px] w-[100%]">
                            <Text
                              className="font-semibold text-bluegray_800 w-[auto]"
                              variant="body4"
                            >
                            ...
                            <Text
                              className="font-semibold lg:ml-[132px] xl:ml-[165px] 2xl:ml-[186px] 3xl:ml-[223px] text-bluegray_800 w-[auto]"
                              variant="body4"
                            >
                              交叉熵采样数据
                            </Text>
                            <Button
                              className="font-normal lg:ml-[391px] xl:ml-[489px] 2xl:ml-[550px] 3xl:ml-[660px] not-italic lg:text-[11px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[19px] text-center w-[9%]"
                              shape="RoundedBorder4"
                              size="lg"
                              variant="FillBlueA400"
                            >
                          ...
                          <Row className="items-center justify-between lg:mt-[17px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] w-[100%]">
                            <Stack className="lg:h-[285px] xl:h-[356px] 2xl:h-[401px] 3xl:h-[481px] lg:w-[284px] xl:w-[355px] 2xl:w-[400px] 3xl:w-[480px]">
                              <Img
                                src="images/img_image62.png"
                                className="imageSixtyTwo"
                                alt="imageSixtyTwo"
                              />
                              <div className="absolute border border-gray_202 border-solid lg:h-[285px] xl:h-[356px] 2xl:h-[401px] 3xl:h-[481px] rounded-radius8 lg:w-[284px] xl:w-[355px] 2xl:w-[400px] 3xl:w-[480px]"></div>
                            </Stack>
                            <Stack className="lg:h-[285px] xl:h-[356px] 2xl:h-[401px] 3xl:h-[481px] outline outline-[1px] outline-gray_202 rounded-radius8 w-[66%]">
                              <Row className="absolute items-center right-[8%] top-[5%] w-[79%]">
                                ...
                                <Text className="npcspeed2" variant="body9">
                                  车辆速度 npc speed
                                </Text>
                                <Text
                                  className="test_relative1"
                                  variant="body9"
                                >
                                  切入主车距离 relative ditance
                                </Text>
                                <Text
                                  className="FourThousandNineHundredThree"
                                  variant="body9"
                                >
                                  结果
                                </Text>
                              </Row>
                              <Stack className="absolute lg:h-[285px] xl:h-[356px] 2xl:h-[401px] 3xl:h-[481px] w-[100%]">
                                <Column className="absolute bottom-[0] items-center justify-start w-[100%]">
                                  <Column className="justify-start w-[100%]">
                                    <Line className="bg-gray_202 h-[1px] w-[100%]" />
                                    <Row className="items-start lg:ml-[11px] xl:ml-[14px] 2xl:ml-[16px] 3xl:ml-[19px] lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] w-[89%]">
                                      <Text
                                        className="One_Two1"
                                        variant="body9"
                                      >
                                      ...
                                      <Text
                                        className="test_5806001"
                                        variant="body9"
                                      >
                                        580，600
                                      </Text>
                                      <Text
                                        className="lg:ml-[108px] xl:ml-[136px] 2xl:ml-[153px] 3xl:ml-[183px] One_Two1"
                                        variant="body9"
                                      >
                                        4
                                      </Text>
                                      <Text className="Five47" variant="body9">
                                        5
                                      </Text>
                                      <Text className="OK1" variant="body9">
                                        OK
                                      </Text>
                                    </Row>
                                    <Line className="bg-gray_202 h-[1px] lg:mt-[10px] xl:mt-[13px] 2xl:mt-[15px] 3xl:mt-[18px] w-[99%]" />
                                    <Row className="items-start lg:ml-[11px] xl:ml-[14px] 2xl:ml-[16px] 3xl:ml-[19px] lg:mt-[12px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[20px] w-[89%]">
                                      <Text
                                        className="One_Two1"
                                        variant="body9"
                                      >
                                    ...
                                    <Line className="bg-gray_202 h-[1px] lg:mt-[11px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] w-[99%]" />
                                    <Line className="bg-gray_202 h-[1px] lg:mt-[34px] xl:mt-[42px] 2xl:mt-[48px] 3xl:mt-[57px] w-[99%]" />
                                    <Line className="bg-gray_202 h-[1px] lg:mt-[34px] xl:mt-[42px] 2xl:mt-[48px] 3xl:mt-[57px] w-[99%]" />
                                    <Line className="bg-gray_202 h-[1px] lg:mt-[34px] xl:mt-[42px] 2xl:mt-[48px] 3xl:mt-[57px] w-[99%]" />
                                    <Line className="bg-gray_202 h-[1px] lg:mt-[34px] xl:mt-[42px] 2xl:mt-[48px] 3xl:mt-[57px] w-[99%]" />
                                    <Column
                                      className="bg-cover bg-repeat justify-end lg:mt-[32px] xl:mt-[40px] 2xl:mt-[46px] 3xl:mt-[55px] p-[2px] w-[99%]"
                                      style={{
                                        backgroundImage:
                                          "url('images/img_group2266.svg')",
                                      }}
                                    >
                                ...
                                <Column className="absolute bottom-[7%] justify-start left-[2%] w-[1%]">
                                  ...
                                  <Text className="Four_One3" variant="body9">
                                    4
                                  </Text>
                                  <Text className="Five_Two1" variant="body9">
                                    5
                                  </Text>
                                  <Text className="Four_One3" variant="body9">
                                    6
                                ...
                                <Column className="absolute bottom-[7%] justify-start right-[36%] w-[1%]">
                                  ...
                                  <Text className="Seven_Two1" variant="body9">
                                    7
                                  </Text>
                                  <Text className="Five_Two1" variant="body9">
                                    5
                                ...
                                <Line className="absolute bg-gray_202 lg:h-[277px] xl:h-[347px] 2xl:h-[390px] 3xl:h-[468px] inset-y-[0] left-[10%] my-[auto] w-[1px]" />
                                <Line className="absolute bg-gray_202 lg:h-[277px] xl:h-[347px] 2xl:h-[390px] 3xl:h-[468px] inset-y-[0] left-[36%] my-[auto] w-[1px]" />
                                <Line className="absolute bg-gray_202 lg:h-[277px] xl:h-[347px] 2xl:h-[390px] 3xl:h-[468px] inset-y-[0] my-[auto] right-[38%] w-[1px]" />
                                <Line className="absolute bg-gray_202 lg:h-[277px] xl:h-[347px] 2xl:h-[390px] 3xl:h-[468px] inset-y-[0] my-[auto] right-[13%] w-[1px]" />
                                <Column
                                  className="absolute bg-cover bg-repeat bottom-[0] items-end justify-start p-[2px] right-[0] w-[1%]"
                                  style={{
                                    backgroundImage:
                                      "url('images/img_group2265.svg')",
                                  }}
                                >
                                  <Line className="bg-gray_300 xl:h-[114px] 2xl:h-[129px] 3xl:h-[154px] lg:h-[92px] lg:mb-[150px] xl:mb-[188px] 2xl:mb-[212px] 3xl:mb-[254px] lg:mt-[4px] xl:mt-[6px] 2xl:mt-[7px] 3xl:mt-[8px] rounded-radius3 w-[6px]" />
                                </Column>
                              </Stack>
                            </Stack>
                          </Row>
                      ...
                      <Column className="bg-white_A700 items-center justify-end xl:my-[10px] 2xl:my-[12px] 3xl:my-[14px] lg:my-[8px] lg:p-[22px] xl:p-[28px] 2xl:p-[32px] 3xl:p-[38px] rounded-radius8 w-[100%]">
                        <Column className="justify-start lg:mt-[4px] xl:mt-[6px] 2xl:mt-[7px] 3xl:mt-[8px] w-[100%]">
                          ...
                          <Row className="items-center lg:mt-[32px] xl:mt-[40px] 2xl:mt-[46px] 3xl:mt-[55px] w-[100%]">
                            ...
                            <Text
                              className="font-semibold lg:ml-[147px] xl:ml-[185px] 2xl:ml-[208px] 3xl:ml-[249px] text-bluegray_800 w-[auto]"
                              variant="body4"
                            >
                              随机采样数据
                            </Text>
                            <Button
                              className="font-normal lg:ml-[406px] xl:ml-[508px] 2xl:ml-[572px] 3xl:ml-[686px] not-italic lg:text-[11px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[19px] text-center w-[9%]"
                              shape="RoundedBorder4"
                              size="lg"
                              variant="FillBlueA400"
                            >
                              ...
                              <Stack className="absolute lg:h-[285px] xl:h-[356px] 2xl:h-[401px] 3xl:h-[481px] w-[100%]">
                                <Column className="absolute bottom-[0] items-center justify-start w-[100%]">
                                  <Column className="justify-start w-[100%]">
                                    <Line className="bg-gray_202 h-[1px] w-[100%]" />
                                    <Row className="items-start lg:ml-[11px] xl:ml-[14px] 2xl:ml-[16px] 3xl:ml-[19px] lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] w-[89%]">
                                      <Text className="One_One" variant="body9">
                                        1
                                      </Text>
                                      <Text
                                        className="test_5806001"
                                      ...
                                      <Text
                                        className="lg:ml-[108px] xl:ml-[136px] 2xl:ml-[153px] 3xl:ml-[183px] One_One"
                                        variant="body9"
                                      >
                                        4
                                      </Text>
                  ...
                  <Row className="items-center justify-between w-[92%]">
                    <Row className="items-start w-[91%]">
                      ...
                      <Stack className="lg:h-[12px] xl:h-[15px] 2xl:h-[17px] 3xl:h-[20px] lg:ml-[11px] xl:ml-[14px] 2xl:ml-[16px] 3xl:ml-[19px] lg:mt-[17px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] w-[9%]">
                        ...
                        <Text
                          className="absolute bottom-[6%] font-alibabapuhuiti1 font-normal inset-x-[40%] text-bluegray_800 w-[auto]"
                          variant="body7"
                        >
                          12
                        </Text>
                ...
                <div className="lg:mt-[22px] xl:mt-[28px] 2xl:mt-[32px] 3xl:mt-[38px] w-[100%]">
                  ...
                  <Column className="items-center justify-start w-[100%]">
                    <Row className="items-center w-[100%]">
                        ...
                        <Stack className="lg:h-[46px] xl:h-[57px] 2xl:h-[65px] 3xl:h-[77px] lg:pr-[105px] xl:pr-[131px] 2xl:pr-[148px] 3xl:pr-[177px] w-[100%]">
                          ...
                          <Row className="absolute h-[max-content] inset-y-[0] items-center left-[3%] my-[auto] lg:pl-[5px] xl:pl-[7px] 2xl:pl-[8px] 3xl:pl-[9px] w-[86%]">
                            ...
                            <Text className="One190" variant="body9">
                              ...
                              <span className="text-bluegray_800 font-alibabapuhuiti1 lg:text-[8px] xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px]">
                                1
                              </span>
                              <span className="text-bluegray_800 lg:text-[8px] xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px]">
                                次
                            ...
                            <Text className="language_One3" variant="body9">
                              2022-08-12 20:23:12
                            </Text>
                            <Text className="time15" variant="body9">
                              1:23
                            </Text>
                            <Button
                      ...
                      <Row className="font-alibabapuhuiti1 items-center justify-center xl:p-[11px] 2xl:p-[13px] 3xl:p-[15px] lg:p-[9px] w-[17%]">
                        <Text className="rowlanguage_two1" variant="body9">
                          2022-08-12 20:23:12
                        </Text>
                      </Row>
                      <Row className="font-alibabapuhuiti1 items-center justify-center xl:p-[11px] 2xl:p-[13px] 3xl:p-[15px] lg:p-[9px] w-[14%]">
                        <Text className="rowtime_one1" variant="body9">
                          1:23
                        </Text>
                      </Row>
                    </Row>
                ...
                <footer className="bg-gray_54 lg:mt-[42px] xl:mt-[53px] 2xl:mt-[60px] 3xl:mt-[72px] rounded-radius8 w-[100%]">
                  <Column className="items-center justify-start mx-[auto] lg:my-[22px] xl:my-[28px] 2xl:my-[32px] 3xl:my-[38px] w-[95%]">
                      ...
                      <Column className="items-center lg:ml-[480px] xl:ml-[600px] 2xl:ml-[675px] 3xl:ml-[810px] rounded-radius4 w-[24%]">
                        <Row className="items-center justify-between w-[100%]">
                          <Column className="w-[21%]">
                            <Text className="Six54" variant="body9">
                              2022-07-25
                            </Text>
                            <Text
                        ...
                        <Row className="items-start w-[96%]">
                          <Column className="items-center justify-start lg:mt-[25px] xl:mt-[32px] 2xl:mt-[36px] 3xl:mt-[43px] w-[49%]">
                            <Row className="items-center w-[100%]">
                              ...
                              <Row className="font-alibabapuhuiti1 items-center justify-between lg:ml-[226px] xl:ml-[283px] 2xl:ml-[319px] 3xl:ml-[383px] w-[23%]">
                                <Text
                            ...
                            <Row className="items-start lg:mt-[51px] xl:mt-[64px] 2xl:mt-[73px] 3xl:mt-[87px] w-[100%]">
                              ...
                              <Row className="items-start justify-between xl:ml-[124px] 2xl:ml-[140px] 3xl:ml-[168px] lg:ml-[99px] w-[55%]">
                                ...
                                <Text
                                  className="font-alibabapuhuiti1 font-normal mb-[1px] text-bluegray_800 w-[auto]"
                                  as="h5"
                                  variant="h5"
                                >
                                  40
                          ...
                          <Stack className="bg-white_A700 lg:h-[148px] xl:h-[186px] 2xl:h-[209px] 3xl:h-[250px] lg:ml-[44px] xl:ml-[55px] 2xl:ml-[62px] 3xl:ml-[74px] mt-[4px] xl:px-[10px] 2xl:px-[12px] 3xl:px-[14px] lg:px-[8px] rounded-radius50 shadow-bs3 lg:w-[147px] xl:w-[185px] 2xl:w-[208px] 3xl:w-[249px]">
                            <Column className="absolute h-[max-content] inset-[0] items-center justify-center m-[auto] w-[34%]">
                              ...
                              <Text
                                className="font-alibabapuhuiti1 test_75B1FF_One"
                                variant="body6"
                              >
                                5000
                              </Text>
                          ...
                          <Column className="justify-start lg:ml-[53px] xl:ml-[66px] 2xl:ml-[75px] 3xl:ml-[90px] lg:mt-[19px] xl:mt-[24px] 2xl:mt-[27px] 3xl:mt-[32px] w-[18%]">
                            <Row className="items-start w-[67%]">
                              <Text
                                className="lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] TwoThousandFourHundredThirtyEight"
                                variant="body7"
                              >
                                通过率
                              </Text>
                              <Text
                                className="font-alibabapuhuiti1 font-normal lg:ml-[11px] xl:ml-[14px] 2xl:ml-[16px] 3xl:ml-[19px] text-bluegray_800 w-[auto]"
                                as="h3"
                                variant="h3"
                              >
                                90
                              ...
                              <Text
                                className="font-alibabapuhuiti1 lg:ml-[3px] xl:ml-[4px] 2xl:ml-[5px] 3xl:ml-[6px] lg:mt-[11px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] columnfivehundredsixty"
                                variant="body5"
                              >
                                %
                              </Text>
                            </Row>
                            <Row className="items-center ml-[1px] lg:mt-[23px] xl:mt-[29px] 2xl:mt-[33px] 3xl:mt-[39px] w-[99%]">
                              <div className="bg-gradient6  2xl:h-[11px] 3xl:h-[13px] lg:h-[8px] xl:h-[9px] rounded-radius2 w-[2%]"></div>
                              <Text
                                className="font-pingfangsc rowtwenty_two"
                                variant="body8"
                              >
                                通过此数
                              </Text>
                              <Text
                                className="3xl:ml-[100px] lg:ml-[59px] xl:ml-[74px] 2xl:ml-[84px] Six54"
                                variant="body6"
                              >
                                4500
                              </Text>
                            </Row>
                            <Row className="items-center ml-[1px] lg:mt-[14px] xl:mt-[17px] 2xl:mt-[20px] 3xl:mt-[24px] w-[99%]">
                              <div className="bg-gradient7  2xl:h-[11px] 3xl:h-[13px] lg:h-[8px] xl:h-[9px] rounded-radius2 w-[2%]"></div>
                              <Text
                                className="font-pingfangsc rowtwenty_two"
                                variant="body8"
                              >
                              ...
                              <Text
                                className="lg:ml-[56px] xl:ml-[71px] 2xl:ml-[80px] 3xl:ml-[96px] Six54"
                                variant="body6"
                              >
                                500
                              </Text>
                    ...
                    <Column className="bg-white_A700 justify-end lg:mt-[17px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] lg:p-[22px] xl:p-[28px] 2xl:p-[32px] 3xl:p-[38px] rounded-radius8 w-[100%]">
                      ...
                      <Column className="bg-white_A700 border border-gray_202 border-solid items-center justify-start lg:mt-[28px] xl:mt-[35px] 2xl:mt-[40px] 3xl:mt-[48px] lg:p-[22px] xl:p-[28px] 2xl:p-[32px] 3xl:p-[38px] rounded-radius8 w-[100%]">
                    ...
                    <Column className="bg-white_A700 items-center justify-end lg:mt-[17px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] lg:p-[22px] xl:p-[28px] 2xl:p-[32px] 3xl:p-[38px] rounded-radius8 w-[100%]">
                      <Column className="justify-start lg:mt-[5px] xl:mt-[7px] 2xl:mt-[8px] 3xl:mt-[9px] w-[100%]">
                        ...
                        <Column className="bg-white_A700 border border-gray_201 border-solid items-center justify-start lg:mt-[28px] xl:mt-[35px] 2xl:mt-[40px] 3xl:mt-[48px] lg:p-[22px] xl:p-[28px] 2xl:p-[32px] 3xl:p-[38px] rounded-radius8 w-[100%]">
                          <Column className="justify-start 3xl:mb-[10px] lg:mb-[6px] xl:mb-[8px] 2xl:mb-[9px] lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] w-[99%]">
                            <Row className="items-start justify-between w-[100%]">
                              <Column className="justify-start mt-[1px] w-[10%]">
                                <Text
                                  className="font-semibold text-bluegray_800 w-[auto]"
                                  variant="body6"
                                >
                              ...
                              <Stack className="lg:h-[168px] xl:h-[210px] 2xl:h-[236px] 3xl:h-[283px] w-[71%]">
                                <Column className="absolute justify-start left-[0] w-[9%]">
                                  ...
                                  <Text
                                    className="font-alibabapuhuiti1 TwoHundred"
                                    variant="body9"
                                  >
                                    200
                                  </Text>
                                  <Text
                                    className="font-alibabapuhuiti1 lg:mt-[27px] xl:mt-[34px] 2xl:mt-[39px] 3xl:mt-[46px] columnfivehundredsixty"
                                    variant="body9"
                                  >
                                    150
                                  </Text>
                                  ...
                                  <Text
                                    className="font-alibabapuhuiti1 lg:ml-[4px] xl:ml-[6px] 2xl:ml-[7px] 3xl:ml-[8px] lg:mt-[27px] xl:mt-[34px] 2xl:mt-[39px] 3xl:mt-[46px] columnfivehundredsixty"
                                    variant="body9"
                                  >
                                    50
                                  </Text>
                                  <Text
                                    className="font-alibabapuhuiti1 xl:ml-[12px] 2xl:ml-[14px] 3xl:ml-[16px] lg:ml-[9px] lg:mt-[27px] xl:mt-[34px] 2xl:mt-[39px] 3xl:mt-[46px] columnfivehundredsixty"
                                    variant="body9"
                                  >
                                    0
                                  </Text>
                          ...
                          <Column className="bg-white_A700 border border-gray_201 border-solid items-center lg:p-[21px] xl:p-[26px] 2xl:p-[30px] 3xl:p-[36px] rounded-radius8 w-[49%]">
                            <Column className="items-center justify-start lg:mb-[5px] xl:mb-[7px] 2xl:mb-[8px] 3xl:mb-[9px] lg:mt-[14px] xl:mt-[18px] 2xl:mt-[21px] 3xl:mt-[25px] w-[98%]">
                              <Row className="items-start justify-between w-[100%]">
                                ...
                                <Stack className="lg:h-[119px] xl:h-[149px] 2xl:h-[168px] 3xl:h-[201px] lg:mt-[45px] xl:mt-[56px] 2xl:mt-[64px] 3xl:mt-[76px] w-[61%]">
                                  <Column className="absolute justify-start left-[0] w-[23%]">
                                    ...
                                    <Text
                                      className="TwoHundred_Two1"
                                      variant="body9"
                                    >
                                      200
                                    </Text>
                                    <Text
                                      className="OneHundredFifty_Two1"
                                      variant="body9"
                                    >
                                      150
                                    </Text>
                                    <Text
                                      className="OneHundred_Two1"
                                      variant="body9"
                                    >
                                      100
                                    </Text>
                                    <Text
                                      className="Fifty_Two3"
                                      variant="body9"
                                    >
                                      50
                                    </Text>
                                    <Text className="Zero_Two1" variant="body9">
                                      0
                                    </Text>
                                  </Column>
                                  <Column
                                    className="absolute bg-cover bg-repeat bottom-[4%] items-center justify-start 2xl:pt-[10px] 3xl:pt-[12px] lg:pt-[7px] xl:pt-[8px] 2xl:px-[10px] 3xl:px-[12px] lg:px-[7px] xl:px-[8px] right-[0] w-[91%]"
                                    style={{
                                      backgroundImage:
                              ...
                              <Row className="items-start lg:mt-[3px] xl:mt-[4px] 2xl:mt-[5px] 3xl:mt-[6px] w-[99%]">
                                ...
                                <Column className="items-end justify-start w-[100%]">
                                  <Stack className="lg:h-[119px] xl:h-[149px] 2xl:h-[168px] 3xl:h-[201px] w-[100%]">
                                    <Stack className="absolute lg:h-[119px] xl:h-[149px] 2xl:h-[168px] 3xl:h-[201px] w-[100%]">
                                      <Stack className="absolute lg:h-[119px] xl:h-[149px] 2xl:h-[168px] 3xl:h-[201px] w-[100%]">
                                        <div className="absolute border border-dashed border-gray_201 bottom-[4%] xl:h-[122px] 2xl:h-[138px] 3xl:h-[165px] lg:h-[98px] right-[0] w-[91%]"></div>
                                        <Column className="absolute justify-start left-[0] w-[23%]">
                                          <Text
                                            className="TwoThousandFourHundredThirtyEight"
                                            variant="body9"
                        ...
                        <Row className="items-center justify-between lg:mt-[22px] xl:mt-[28px] 2xl:mt-[32px] 3xl:mt-[38px] w-[100%]">
                          <Column className="bg-white_A700 border border-gray_201 border-solid items-center lg:p-[22px] xl:p-[28px] 2xl:p-[32px] 3xl:p-[38px] rounded-radius8 w-[49%]">
                            <Column className="justify-start lg:mb-[4px] xl:mb-[5px] 2xl:mb-[6px] 3xl:mb-[7px] lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[99%]">
                              <Row className="items-start justify-between w-[100%]">
                                <Column className="items-center justify-start xl:mb-[10px] 2xl:mb-[12px] 3xl:mb-[14px] lg:mb-[8px] w-[13%]">
                                  <Text
                                    className="font-semibold text-bluegray_800 w-[auto]"
                                    variant="body6"
                                  >
                              ...
                              <Row className="items-start lg:mt-[3px] xl:mt-[4px] 2xl:mt-[5px] 3xl:mt-[6px] w-[95%]">
                    ...
                    <Column className="bg-white_A700 items-center justify-end lg:mt-[17px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] lg:p-[22px] xl:p-[27px] 2xl:p-[31px] 3xl:p-[37px] rounded-radius8 w-[100%]">
                            ...
                            <Row className="items-center rounded-radius4 w-[100%]">
                              <Row className="items-center justify-between w-[12%]">
                                ...
                                <Text
                                  ...
                                  variant="body6"
                                >
                                  <span className="text-bluegray_500 font-alibabapuhuiti1 lg:text-[14px] xl:text-[17px] 2xl:text-[20px] 3xl:text-[24px]">
                                    C
                                  </span>
                                  <span className="text-bluegray_500 font-alibabapuhuiti1 lg:text-[12px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px]">
                                    {" "}
                                  </span>
              ...
              <Line className="bg-gray_300 lg:h-[57px] xl:h-[72px] 2xl:h-[81px] 3xl:h-[97px] lg:mt-[2163px] xl:mt-[2706px] 2xl:mt-[3044px] 3xl:mt-[3652px] rounded-radius2 w-[4px]" />
            </Row>
          </Column>
        </Column>
      </Column>

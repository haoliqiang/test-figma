      ...
      <Column className="bg-black_900_87 font-pingfangsc items-center justify-start mx-[auto] lg:p-[128px] xl:p-[160px] 2xl:p-[180px] 3xl:p-[216px] w-[100%]">
        <Column className="bg-white_A700 items-center justify-start lg:pt-[12px] xl:pt-[16px] 2xl:pt-[18px] 3xl:pt-[21px] rounded-radius10 w-[44%]">
          ...
          <Column className="items-center justify-start lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[100%]">
            ...
            <Row className="items-center justify-end ml-[auto] mt-[2px] w-[77%]">
              <Column className="bg-white_A700 border border-gray_302 border-solid 2xl:p-[10px] 3xl:p-[12px] lg:p-[7px] xl:p-[8px] rounded-radius4 w-[84%]">
                <Text
                  className="bg-blue_A400_3d font-normal ml-[2px] not-italic py-[2px] text-black_900 w-[84px]"
                  variant="body8"
                >
                  未命名文件夹
                </Text>
              ...
              <Img
                src="images/img_airplane_24X24.svg"
                className="xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] lg:ml-[8px] close5"
                alt="airplane"
              />
              <Img
            ...
            <RadioGroup className="mt-[2px] w-[87%]" name="radiogroup20220804">
              <Radio
                value="20220804"

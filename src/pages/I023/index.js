    ...
    <>
      <Column className="bg-white_A700 font-pingfangsc items-center justify-start mx-[auto] w-[100%]">
        <Stack className="3xl:h-[1081px] lg:h-[640px] xl:h-[801px] 2xl:h-[901px] w-[100%]">
              ...
              <Row className="items-center justify-between xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] lg:ml-[8px] lg:mt-[18px] xl:mt-[23px] 2xl:mt-[26px] 3xl:mt-[31px] w-[97%]">
                <Row className="items-center justify-between w-[38%]">
                  <CheckBox
                    ...
                    name="SixThousandThreeHundredSixtyThree"
                    label="全选"
          ...
          <Stack className="absolute bg-black_900_a2 3xl:h-[1081px] lg:h-[640px] xl:h-[801px] 2xl:h-[901px] lg:px-[37px] xl:px-[47px] 2xl:px-[53px] 3xl:px-[63px] w-[100%]">
            <Column className="absolute h-[max-content] inset-y-[0] items-center justify-start left-[21%] my-[auto] w-[46%]">
              <Row className="items-start w-[100%]">
                <div className="bg-bluegray_102 lg:h-[33px] xl:h-[41px] 2xl:h-[47px] 3xl:h-[56px] lg:mt-[27px] xl:mt-[34px] 2xl:mt-[39px] 3xl:mt-[46px] w-[24%]"></div>
                <div className="bg-bluegray_102 lg:h-[27px] xl:h-[33px] 2xl:h-[38px] 3xl:h-[45px] lg:ml-[182px] xl:ml-[228px] 2xl:ml-[257px] 3xl:ml-[308px] w-[16%]"></div>
                <div className="bg-bluegray_102 lg:h-[466px] xl:h-[582px] 2xl:h-[655px] 3xl:h-[786px] 2xl:ml-[110px] 3xl:ml-[132px] lg:ml-[78px] xl:ml-[97px] w-[6%]"></div>
              </Row>
            </Column>
            <div className="absolute bg-bluegray_102 3xl:h-[111px] lg:h-[66px] xl:h-[82px] 2xl:h-[93px] right-[26%] top-[11%] w-[35%]"></div>
            <Column className="absolute bg-white_A700 h-[max-content] inset-y-[0] items-center justify-start left-[19%] my-[auto] lg:pt-[12px] xl:pt-[16px] 2xl:pt-[18px] 3xl:pt-[21px] rounded-radius10 w-[50%]">
              <Column className="items-center justify-start w-[100%]">
                ...
                <Column className="items-center justify-end lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] lg:pt-[21px] xl:pt-[26px] 2xl:pt-[30px] 3xl:pt-[36px] w-[100%]">
                  <Row className="items-center justify-between w-[91%]">
                    <Text
                  ...
                  <Column className="items-center justify-start lg:mt-[29px] xl:mt-[37px] 2xl:mt-[42px] 3xl:mt-[50px] w-[90%]">
                      ...
                      <Row className="items-center justify-between w-[100%]">
                        ...
                        <Row className="items-center justify-between py-[2px] w-[76%]">
                          <CheckBox
                            ...
                            inputClassName="h-[16px] mr-[5px] w-[16px]"
                            name="SixThousandThreeHundredNinetyTwo"
                            label="交叉熵采样"
                            shape="RoundedBorder2"
                            size="sm"
                          ...
                          <CheckBox
                            ...
                            name="SixThousandThreeHundredNinetyThree"
                            label="随机采样"
                            size="sm"
                          ></CheckBox>
                          <CheckBox
                          ...
                          <CheckBox
                            className="font-normal not-italic xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] lg:text-[9px] text-bluegray_800"
                            inputClassName="h-[16px] mr-[5px] w-[16px]"
                            name="SixThousandThreeHundredNinetyFour"
                            label="随机采样"
                            shape="RoundedBorder2"
                            size="sm"
                            variant="OutlineBluegray1001_2"
                      ...
                      <Column className="justify-start lg:mt-[11px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] w-[76%]">
                        <Row className="items-center justify-between py-[2px] w-[100%]">
                          <CheckBox
                            className="font-normal not-italic xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] lg:text-[9px] text-bluegray_800"
                            inputClassName="h-[16px] mr-[5px] w-[16px]"
                            name="SixThousandThreeHundredNinetyFive"
                            label="交叉熵采样"
                            shape="RoundedBorder2"
                            size="sm"
                            variant="OutlineBluegray1001_2"
                          ...
                          <CheckBox
                            className="font-normal not-italic xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] lg:text-[9px] text-bluegray_800"
                            inputClassName="mr-[5px] w-[undefinedpx]"
                            name="SixThousandThreeHundredNinetySix"
                            label="随机采样"
                            size="sm"
                          ></CheckBox>
                          <CheckBox
                          ...
                          <CheckBox
                            className="font-normal not-italic xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] lg:text-[9px] text-bluegray_800"
                            inputClassName="h-[16px] mr-[5px] w-[16px]"
                            name="SixThousandThreeHundredNinetySeven"
                            label="随机采样"
                            shape="RoundedBorder2"
                            size="sm"
                            variant="OutlineBluegray1001_2"
                        ...
                        <Row className="items-center lg:mt-[11px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] py-[2px] w-[45%]">
                          <CheckBox
                            className="font-normal not-italic xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] lg:text-[9px] text-bluegray_800"
                            inputClassName="h-[16px] mr-[5px] w-[16px]"
                            name="SixThousandThreeHundredNinetyEight"
                            label="交叉熵采样"
                            shape="RoundedBorder2"
                            size="sm"
                            variant="OutlineBluegray1001_2"
                          ...
                          <CheckBox
                            ...
                            inputClassName="mr-[5px] w-[undefinedpx]"
                            name="SixThousandThreeHundredNinetyNine"
                            label="随机采样"
                            size="sm"
                          ></CheckBox>
                        </Row>
                  ...
                  <Row className="items-center justify-between lg:mt-[29px] xl:mt-[37px] 2xl:mt-[42px] 3xl:mt-[50px] w-[91%]">
                    <Text
                      className="font-medium text-bluegray_500 w-[auto]"
                      variant="body8"
                    >
                  ...
                  <Column className="items-center justify-start lg:mt-[50px] xl:mt-[63px] 2xl:mt-[71px] 3xl:mt-[85px] w-[91%]">
                  ...
                  <Row className="items-center lg:mt-[20px] xl:mt-[25px] 2xl:mt-[29px] 3xl:mt-[34px] w-[91%]">
                    <Text
                      className="font-medium text-bluegray_500 w-[auto]"
                      variant="body8"
                    >
                  ...
                  <Column className="bg-white_A700 items-center justify-start lg:mt-[25px] xl:mt-[32px] 2xl:mt-[36px] 3xl:mt-[43px] lg:pb-[11px] xl:pb-[14px] 2xl:pb-[16px] 3xl:pb-[19px] rounded-bl-[10px] rounded-br-[10px] rounded-tl-[0] rounded-tr-[0] w-[100%]">

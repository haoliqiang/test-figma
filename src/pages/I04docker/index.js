              ...
              <Column className="justify-start lg:ml-[22px] xl:ml-[28px] 2xl:ml-[32px] 3xl:ml-[38px] lg:mt-[31px] xl:mt-[39px] 2xl:mt-[44px] 3xl:mt-[52px] w-[58%]">
                ...
                <Row className="items-center lg:mt-[29px] xl:mt-[37px] 2xl:mt-[42px] 3xl:mt-[50px] py-[2px] w-[73%]">
                  ...
                  <RadioGroup
                    ...
                    name="radiogroupfivethousandeighthundredthirtyone"
                  >
                    <Radio
                      value="undefined"
                ...
                <Text
                  className="font-normal lg:leading-[15px] xl:leading-[19px] 2xl:leading-[22px] 3xl:leading-[26px] lg:ml-[111px] xl:ml-[139px] 2xl:ml-[157px] 3xl:ml-[188px] 2xl:mt-[11px] 3xl:mt-[13px] lg:mt-[7px] xl:mt-[9px] not-italic text-bluegray_200 w-[70%]"
                  variant="body9"
                >
                  <span className="text-bluegray_200 font-pingfangsc lg:text-[8px] xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px]">
                    docker镜像算法说明：文件包根目录编译脚本start.py,demo包参考demo.zip.参考说明：
                  </span>

      ...
      <Column className="bg-white_A700 font-pingfangsc items-center justify-start mx-[auto] lg:pb-[36px] xl:pb-[46px] 2xl:pb-[52px] 3xl:pb-[62px] w-[100%]">
        <Column className="items-center justify-start w-[100%]">
          ...
          <Column className="justify-start w-[100%]">
            <Stack className="lg:h-[114px] xl:h-[143px] 2xl:h-[161px] 3xl:h-[193px] w-[100%]">
              <Stack className="test_20220825">
                <Stack className="absolute lg:h-[114px] xl:h-[143px] 2xl:h-[161px] 3xl:h-[193px] right-[0] w-[87%]">
                  <Img
                    src="images/img_image1_160X918.png"
                    className="imageOne"
                    alt="imageOne"
                  />
                  <Img
                    src="images/img_20220825_160X1248.png"
            ...
            <Column className="items-center justify-start lg:ml-[22px] xl:ml-[28px] 2xl:ml-[32px] 3xl:ml-[38px] lg:mt-[28px] xl:mt-[35px] 2xl:mt-[40px] 3xl:mt-[48px] w-[96%]">
              <Stack className="lg:h-[100px] xl:h-[125px] 2xl:h-[141px] 3xl:h-[169px] w-[100%]">
                <Column className="absolute bottom-[1%] inset-x-[0] items-center justify-start w-[100%]">
                  <Column className="items-center justify-start w-[97%]">
                    <Row className="items-center justify-between w-[100%]">
                      <Row className="items-center w-[12%]">
                        <div className="bg-gray_202 lg:h-[26px] xl:h-[33px] 2xl:h-[37px] 3xl:h-[44px] rounded-radius4 lg:w-[25px] xl:w-[32px] 2xl:w-[36px] 3xl:w-[43px]"></div>
                        <Text className="rowrectangle348" variant="body4">
                          任务排队中
                        </Text>
                      </Row>
                    ...
                    <Row className="items-center justify-between lg:mt-[18px] xl:mt-[23px] 2xl:mt-[26px] 3xl:mt-[31px] w-[100%]">
                      ...
                      <Button
                        className="font-normal not-italic xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[8px] text-center w-[5%]"
                ...
                <Stack className="absolute border border-gray_202 border-solid lg:h-[100px] xl:h-[125px] 2xl:h-[141px] 3xl:h-[169px] lg:px-[24px] xl:px-[31px] 2xl:px-[35px] 3xl:px-[42px] rounded-radius8 w-[100%]">
                  <Stack className="absolute lg:h-[13px] xl:h-[16px] 2xl:h-[18px] 3xl:h-[21px] left-[0] top-[1%] w-[1%]">
                    <Img
                      src="images/img_ticket.svg"
                      className="absolute lg:h-[13px] xl:h-[16px] 2xl:h-[18px] 3xl:h-[21px] w-[100%]"
                      alt="ticket"
                    />
                  </Stack>
                </Stack>
              ...
              <Column className="justify-start w-[100%]">
                          ...
                          <Stack className="absolute lg:h-[414px] xl:h-[518px] 2xl:h-[583px] 3xl:h-[699px] w-[100%]">
                            <Column className="absolute justify-start w-[100%]">
                              <Stack className="lg:h-[323px] xl:h-[403px] 2xl:h-[454px] 3xl:h-[544px] w-[100%]">
                                ...
                                <Text
                                  className="absolute right-[36%] top-[20%] columnu1230"
                                  variant="body9"
                                >
                                  2020-09-09 21:00:02
                                </Text>
                              ...
                              <Row className="items-start lg:mt-[42px] xl:mt-[53px] 2xl:mt-[60px] 3xl:mt-[72px] w-[29%]">
                                ...
                                <Column className="bg-white_A700 justify-start lg:p-[5px] xl:p-[7px] 2xl:p-[8px] 3xl:p-[9px] w-[90%]">
                                  <Row className="items-end 3xl:mb-[10px] lg:mb-[6px] xl:mb-[8px] 2xl:mb-[9px] mt-[4px] rounded-radius4 w-[91%]">
                                    <Column
                                      className="bg-cover bg-repeat lg:h-[29px] xl:h-[36px] 2xl:h-[41px] 3xl:h-[49px] items-center justify-start rounded-radius4 lg:w-[28px] xl:w-[35px] 2xl:w-[40px] 3xl:w-[48px]"
                                      style={{
                                        backgroundImage:
                ...
                <Row className="items-center xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] lg:ml-[8px] lg:mt-[15px] xl:mt-[19px] 2xl:mt-[22px] 3xl:mt-[26px] w-[16%]">
                  <CheckBox
                    ...
                    name="ThreeHundredEightySix"
                    label="全选"
                    shape="RoundedBorder2"
                    size="sm"
                    variant="OutlineGray402"
                  ></CheckBox>
                  <div className="bg-gray_202 2xl:h-[11px] 3xl:h-[13px] lg:h-[8px] xl:h-[9px] lg:ml-[17px] xl:ml-[21px] 2xl:ml-[24px] 3xl:ml-[28px] w-[1px]"></div>
                  <Button

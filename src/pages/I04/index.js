      ...
      <Column className="bg-white_A700 font-pingfangsc items-center justify-start mx-[auto] lg:pb-[36px] xl:pb-[46px] 2xl:pb-[52px] 3xl:pb-[62px] w-[100%]">
        <Column className="items-center justify-start w-[100%]">
          ...
          <Column className="justify-start w-[100%]">
              ...
              <Column className="items-center justify-start lg:mt-[17px] xl:mt-[22px] 2xl:mt-[25px] 3xl:mt-[30px] w-[100%]">
                <Column className="items-center justify-start w-[100%]">
                    ...
                    <Row className="items-center justify-between w-[100%]">
                      <Row className="items-center w-[9%]">
                        <Column className="bg-gray_202 lg:h-[26px] xl:h-[33px] 2xl:h-[37px] 3xl:h-[44px] items-center lg:px-[5px] xl:px-[7px] 2xl:px-[8px] 3xl:px-[9px] rounded-radius4 lg:w-[25px] xl:w-[32px] 2xl:w-[36px] 3xl:w-[43px]">
                          <Column className="bg-red_601 items-center justify-start lg:px-[4px] xl:px-[5px] 2xl:px-[6px] 3xl:px-[7px] rounded-radius50 user">
                            <div className="bg-gray_202 3xl:h-[10px] lg:h-[6px] xl:h-[8px] 2xl:h-[9px] rounded-radius1 lg:w-[5px] xl:w-[7px] 2xl:w-[8px] 3xl:w-[9px]"></div>
                          </Column>
                        </Column>
                        <Text className="rowrectangle209" variant="body4">
                          已终止
                        </Text>
                      </Row>
                  ...
                  <Stack className="lg:h-[3px] xl:h-[4px] 3xl:h-[5px] 2xl:h-[5px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[16px] lg:mt-[9px] w-[100%]">
                    ...
                    <Line className="absolute bg-red_601 h-[4px] left-[0] w-[67%]" />
                  </Stack>
                </Column>
              </Column>
            </Column>
            ...
            <footer className="lg:ml-[22px] xl:ml-[28px] 2xl:ml-[32px] 3xl:ml-[38px] lg:mt-[38px] xl:mt-[48px] 2xl:mt-[54px] 3xl:mt-[64px] w-[96%]">
              <Column className="justify-start w-[100%]">

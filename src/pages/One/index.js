        ...
        <Column className="justify-start lg:mb-[24px] xl:mb-[31px] 2xl:mb-[35px] 3xl:mb-[42px] 2xl:mt-[11px] 3xl:mt-[13px] lg:mt-[7px] xl:mt-[9px] w-[98%]">
          ...
          <footer className="lg:mt-[37px] xl:mt-[46px] 2xl:mt-[52px] 3xl:mt-[62px] w-[100%]">
            <Column className="justify-start w-[100%]">
              ...
              <Column className="items-center justify-start lg:mt-[14px] xl:mt-[18px] 2xl:mt-[20px] 3xl:mt-[24px] w-[18%]">
                <Column className="bg-white_A700 border border-gray_200 border-solid items-center justify-start lg:p-[5px] xl:p-[6px] 2xl:p-[7px] 3xl:p-[9px] w-[100%]">
                  <Row className="items-center justify-between 2xl:mb-[10px] 3xl:mb-[12px] lg:mb-[7px] xl:mb-[9px] w-[99%]">
                    <Text className="rowbrandone" variant="body9">
                      White
                    </Text>
                ...
                <Column className="bg-gray_52 items-center justify-start lg:p-[5px] xl:p-[6px] 2xl:p-[7px] 3xl:p-[9px] w-[100%]">
                ...
                <Column className="bg-gray_101 items-center justify-start lg:p-[5px] xl:p-[6px] 2xl:p-[7px] 3xl:p-[9px] w-[100%]">
                  <Row className="items-start justify-between 3xl:mb-[11px] lg:mb-[6px] xl:mb-[8px] 2xl:mb-[9px] w-[98%]">
                    <Text className="GrayOne" variant="body9">
                      Gray2
                    </Text>
                ...
                <Column className="bg-gray_201 items-center justify-start lg:p-[5px] xl:p-[6px] 2xl:p-[7px] 3xl:p-[9px] w-[100%]">
                ...
                <Column className="bg-gray_300 items-center justify-start lg:p-[3px] xl:p-[4px] 2xl:p-[5px] 3xl:p-[6px] w-[100%]">
                ...
                <Column className="bg-bluegray_100 items-center justify-start xl:p-[3px] lg:p-[3px] 2xl:p-[4px] 3xl:p-[5px] w-[100%]">
                ...
                <Column className="bg-bluegray_201 items-center justify-start lg:p-[5px] xl:p-[6px] 2xl:p-[7px] 3xl:p-[9px] w-[100%]">
                  <Row className="items-start justify-between 3xl:mb-[11px] lg:mb-[6px] xl:mb-[8px] 2xl:mb-[9px] w-[99%]">
                    <Text className="WarningSix" variant="body9">
                      Gray6
                    </Text>
                ...
                <Column className="bg-bluegray_202 items-center justify-start lg:p-[5px] xl:p-[6px] 2xl:p-[7px] 3xl:p-[9px] w-[100%]">
                  <Row className="items-start justify-between 3xl:mb-[11px] lg:mb-[6px] xl:mb-[8px] 2xl:mb-[9px] w-[99%]">
                    <Text className="WarningSix" variant="body9">
                      Gray7
                    </Text>
                ...
                <Column className="bg-bluegray_300 items-center justify-start lg:p-[5px] xl:p-[6px] 2xl:p-[7px] 3xl:p-[9px] w-[100%]">
                  <Row className="items-start justify-between 3xl:mb-[11px] lg:mb-[6px] xl:mb-[8px] 2xl:mb-[9px] w-[99%]">
                    <Text className="WarningSix" variant="body9">
                      Gray8
                    </Text>
                ...
                <Column className="bg-bluegray_401 items-center justify-start lg:p-[5px] xl:p-[6px] 2xl:p-[7px] 3xl:p-[9px] w-[100%]">
                  <Row className="items-start justify-between 3xl:mb-[11px] lg:mb-[6px] xl:mb-[8px] 2xl:mb-[9px] w-[99%]">
                    <Text className="WarningSix" variant="body9">
                      Gray9
                    </Text>
                ...
                <Column className="bg-bluegray_500 items-center justify-start lg:p-[5px] xl:p-[6px] 2xl:p-[7px] 3xl:p-[9px] w-[100%]">
                  <Row className="items-start justify-between 3xl:mb-[11px] lg:mb-[6px] xl:mb-[8px] 2xl:mb-[9px] w-[99%]">
                    <Text className="WarningSix" variant="body9">
                      Gray10
                    </Text>
                ...
                <Column className="bg-bluegray_600 items-center justify-start lg:p-[5px] xl:p-[6px] 2xl:p-[7px] 3xl:p-[9px] w-[100%]">
                  <Row className="items-start justify-between 3xl:mb-[11px] lg:mb-[6px] xl:mb-[8px] 2xl:mb-[9px] w-[99%]">
                    <Text className="WarningSix" variant="body9">
                      Gray11
                    </Text>
                ...
                <Column className="bg-bluegray_800 items-center justify-start lg:p-[5px] xl:p-[6px] 2xl:p-[7px] 3xl:p-[9px] w-[100%]">
                  <Row className="items-start justify-between 3xl:mb-[11px] lg:mb-[6px] xl:mb-[8px] 2xl:mb-[9px] w-[99%]">
                    <Text className="WarningSix" variant="body9">
                      Gray14
                    </Text>

...
const Page51 = () => {
  return (
    <>
      <Column className="bg-white_A700 font-pingfangsc items-center justify-start mx-[auto] lg:pb-[31px] xl:pb-[39px] 2xl:pb-[44px] 3xl:pb-[52px] w-[100%]">
          ...
          <Stack className="lg:h-[159px] xl:h-[199px] 2xl:h-[224px] 3xl:h-[268px] w-[100%]">
            <Stack className="bottom-[0] test_20220825">
              <Stack className="absolute lg:h-[114px] xl:h-[143px] 2xl:h-[161px] 3xl:h-[193px] right-[0] w-[87%]">
                <Img
                  src="images/img_image1_37.png"
                  className="imageOne"
                  alt="imageOne"
                />
                <Img
                  src="images/img_20220825_37.png"
          ...
          <Column className="justify-start lg:mt-[28px] xl:mt-[35px] 2xl:mt-[40px] 3xl:mt-[48px] w-[97%]">
            ...
            <Row className="items-start justify-between lg:mt-[45px] xl:mt-[56px] 2xl:mt-[64px] 3xl:mt-[76px] w-[100%]">
              <Column className="justify-start w-[99%]">
                <Line className="bg-gray_201 h-[1px] rounded-radius05 w-[100%]" />
                ...
                <Row className="items-center xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] lg:ml-[8px] lg:mt-[15px] xl:mt-[19px] 2xl:mt-[22px] 3xl:mt-[26px] w-[16%]">
                  <CheckBox
                    ...
                    name="FourThousandOneHundredEleven"
                    label="全选"
                ...
                <footer className="bg-gray_54 lg:mt-[42px] xl:mt-[53px] 2xl:mt-[60px] 3xl:mt-[72px] rounded-radius8 w-[100%]">
                  <Column className="items-center justify-start mx-[auto] lg:my-[22px] xl:my-[28px] 2xl:my-[32px] 3xl:my-[38px] w-[95%]">
                    <Row className="items-center pr-[1px] pt-[1px] w-[100%]">
                      ...
                      <Column className="items-center lg:ml-[403px] xl:ml-[504px] 2xl:ml-[567px] 3xl:ml-[680px] rounded-radius4 w-[24%]">
                      ...
                      <Column className="bg-white_A700 border border-gray_201 border-solid items-center justify-start lg:mt-[41px] xl:mt-[51px] 2xl:mt-[58px] 3xl:mt-[69px] lg:p-[22px] xl:p-[28px] 2xl:p-[32px] 3xl:p-[38px] rounded-radius8 w-[100%]">
                        <Row className="items-start w-[96%]">
                          <Column className="items-center justify-start lg:mt-[25px] xl:mt-[32px] 2xl:mt-[36px] 3xl:mt-[43px] w-[49%]">
                            <Row className="items-center w-[100%]">
                              <Img
                                ...
                                className="close5"
                                alt="FourThousandOneHundredThirtyTwo"
                              />
                              <Text
                          ...
                          <Stack className="bg-white_A700 lg:h-[148px] xl:h-[186px] 2xl:h-[209px] 3xl:h-[250px] lg:ml-[44px] xl:ml-[55px] 2xl:ml-[62px] 3xl:ml-[74px] mt-[4px] xl:px-[10px] 2xl:px-[12px] 3xl:px-[14px] lg:px-[8px] rounded-radius50 shadow-bs3 lg:w-[147px] xl:w-[185px] 2xl:w-[208px] 3xl:w-[249px]">
                            <Column className="absolute h-[max-content] inset-[0] items-end justify-center m-[auto] w-[20%]">
                              <Text
                          ...
                          <Column className="justify-start lg:ml-[53px] xl:ml-[66px] 2xl:ml-[75px] 3xl:ml-[90px] lg:mt-[20px] xl:mt-[25px] 2xl:mt-[29px] 3xl:mt-[34px] w-[18%]">
                            ...
                            <Row className="items-start ml-[1px] lg:mt-[22px] xl:mt-[28px] 2xl:mt-[32px] 3xl:mt-[38px] w-[99%]">
                              ...
                              <Text
                                className="3xl:ml-[117px] lg:ml-[69px] xl:ml-[87px] 2xl:ml-[98px] Six24"
                                variant="body6"
                              >
                                4500
                              </Text>
                            ...
                            <Row className="items-start ml-[1px] lg:mt-[14px] xl:mt-[17px] 2xl:mt-[20px] 3xl:mt-[24px] w-[99%]">
                              ...
                              <Text
                                className="3xl:ml-[112px] lg:ml-[66px] xl:ml-[83px] 2xl:ml-[94px] Six24"
                                variant="body6"
                              >
                                500
                              </Text>
                    ...
                    <Column className="bg-white_A700 items-center justify-start lg:mt-[17px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] lg:p-[22px] xl:p-[28px] 2xl:p-[32px] 3xl:p-[38px] rounded-radius8 w-[100%]">
                      <Column className="items-center justify-start w-[100%]">
                        <Column className="bg-white_A700 border border-gray_201 border-solid items-center justify-start lg:p-[22px] xl:p-[28px] 2xl:p-[32px] 3xl:p-[38px] rounded-bl-[0] rounded-br-[0] rounded-tl-[8px] rounded-tr-[8px] w-[100%]">
                              ...
                              <Row className="items-start justify-between w-[100%]">
                                ...
                                <Stack className="lg:h-[119px] xl:h-[148px] 2xl:h-[167px] 3xl:h-[200px] lg:mt-[45px] xl:mt-[56px] 2xl:mt-[64px] 3xl:mt-[76px] w-[61%]">
                                  <Column className="absolute justify-start left-[0] w-[23%]">
                                    ...
                                    <Text
                                      className="font-alibabapuhuiti font-normal lg:ml-[5px] xl:ml-[7px] 2xl:ml-[8px] 3xl:ml-[9px] lg:mt-[15px] xl:mt-[19px] 2xl:mt-[22px] 3xl:mt-[26px] text-bluegray_500 w-[auto]"
                                      variant="body9"
                                    >
                                      50
                                    </Text>
                                    <Text className="Zero_Two" variant="body9">
                                      0
                                    </Text>
                                  </Column>
                                  <Column
                              ...
                              <Row className="items-start justify-between w-[100%]">
                                ...
                                <Stack className="lg:h-[119px] xl:h-[148px] 2xl:h-[167px] 3xl:h-[200px] lg:mt-[45px] xl:mt-[56px] 2xl:mt-[64px] 3xl:mt-[76px] w-[62%]">
                                  <Column className="absolute justify-start left-[0] w-[23%]">
                                    ...
                                    <Text className="Fifty_Two" variant="body9">
                                      50
                                    </Text>
                                    <Text className="Zero_Two" variant="body9">
                                      0

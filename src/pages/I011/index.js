        ...
        <Column className="items-center justify-start w-[100%]">
          ...
          <Column className="items-center justify-start lg:mt-[16px] xl:mt-[20px] 2xl:mt-[23px] 3xl:mt-[27px] w-[96%]">
            <Stack className="3xl:h-[117px] lg:h-[69px] xl:h-[87px] 2xl:h-[98px] w-[100%]">
              <Stack className="absolute 3xl:h-[116px] lg:h-[69px] xl:h-[86px] 2xl:h-[97px] top-[1%] w-[100%]">
                <Column className="absolute bg-white_A700 inset-x-[0] items-center justify-start lg:pt-[5px] xl:pt-[7px] 2xl:pt-[8px] 3xl:pt-[9px] top-[0] w-[100%]">
                  <Column className="items-center justify-start w-[100%]">
                    <Column className="items-center justify-start w-[100%]">
                      <Row className="items-start w-[92%]">
                        <Text
                          className="flex items-center FiveHundredFiftyThree"
                          variant="body9"
                        >
                          ID
                        </Text>
                        <Column className="items-center justify-start xl:ml-[104px] 2xl:ml-[117px] 3xl:ml-[140px] lg:ml-[83px] mt-[2px] w-[2%]">
                          <Text
                        ...
                        <Row className="items-start justify-center lg:ml-[219px] xl:ml-[274px] 2xl:ml-[309px] 3xl:ml-[371px] w-[5%]">
                          <Text
                        ...
                        <Text
                          className="lg:ml-[135px] xl:ml-[169px] 2xl:ml-[191px] 3xl:ml-[229px] rowsixhundredfiftythree"
                          variant="body9"
                        >
                          任务状态
                        </Text>
                        <Row className="items-start justify-center xl:ml-[120px] 2xl:ml-[136px] 3xl:ml-[163px] lg:ml-[96px] w-[5%]">
                          <Text
                            className="rowsixhundredfiftythree"
                            variant="body9"
                          >
                        ...
                        <Text
                          className="2xl:ml-[112px] 3xl:ml-[134px] lg:ml-[79px] xl:ml-[99px] rowsixhundredfiftythree"
                          variant="body9"
                        >
                          任务结果
                        </Text>
                        <Text
                          className="xl:ml-[102px] 2xl:ml-[115px] 3xl:ml-[138px] lg:ml-[81px] rowsixhundredfiftythree"
                          variant="body9"
                        >
                          操作
                        </Text>
                ...
                <Stack className="absolute bg-white_A700 bottom-[0] lg:h-[52px] xl:h-[65px] 2xl:h-[73px] 3xl:h-[87px] inset-x-[0] w-[100%]">
                  <Column className="absolute items-center justify-start w-[100%]">
                    <Row className="items-center justify-evenly w-[100%]">
                      <Column className="bg-white_A700 items-center xl:p-[10px] 2xl:p-[12px] 3xl:p-[14px] lg:p-[8px] w-[3%]">
                        <div className="bg-white_A700 border border-bluegray_100 border-solid lg:h-[13px] xl:h-[17px] 2xl:h-[19px] 3xl:h-[22px] lg:my-[10px] xl:my-[13px] 2xl:my-[15px] 3xl:my-[18px] rounded-radius2 w-[100%]"></div>
                      </Column>
                      <Column className="bg-white_A700 lg:p-[5px] xl:p-[7px] 2xl:p-[8px] 3xl:p-[9px] w-[9%]">
                        <Text className="columnu12301" variant="body9">
                          U1230
                        </Text>
                      </Column>
                      <Column className="bg-white_A700 lg:p-[5px] xl:p-[7px] 2xl:p-[8px] 3xl:p-[9px] w-[24%]">
                        <Row className="items-center lg:my-[3px] xl:my-[4px] 2xl:my-[5px] 3xl:my-[6px] rounded-radius4 w-[90%]">
                          <Column
                            className="bg-cover bg-repeat items-center rounded-radius4 w-[14%]"
                            style={{
                              backgroundImage: "url('images/img_group777.png')",
                            }}
                          >
                            <div className="bg-bluegray_800_63 lg:h-[32px] xl:h-[41px] 2xl:h-[46px] 3xl:h-[55px] rounded-radius4 w-[100%]"></div>
                          </Column>
                          <Column className="2xl:ml-[10px] 3xl:ml-[12px] lg:ml-[7px] xl:ml-[8px] w-[83%]">
                            <Text
                      ...
                      <Column className="bg-white_A700 lg:p-[5px] xl:p-[7px] 2xl:p-[8px] 3xl:p-[9px] w-[19%]">
                        <Text className="columnu12301" variant="body9">
                          2022-08-12 20:23:12
                        </Text>
                      </Column>
                      <Column className="bg-white_A700 lg:p-[5px] xl:p-[7px] 2xl:p-[8px] 3xl:p-[9px] w-[13%]">
                        <Text
                          className="lg:my-[14px] xl:my-[18px] 2xl:my-[21px] 3xl:my-[25px] rowbrand"
                          variant="body9"
                        >
                          排队中
                        </Text>
                      ...
                      <Column className="bg-white_A700 lg:p-[5px] xl:p-[7px] 2xl:p-[8px] 3xl:p-[9px] w-[13%]">
                        <Text
                          className="lg:mb-[17px] xl:mb-[21px] 2xl:mb-[24px] 3xl:mb-[28px] lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] rowbrand"
                          variant="body9"
                        >
                          --
                        </Text>
                      </Column>
                      <Column className="bg-white_A700 2xl:p-[10px] 3xl:p-[12px] lg:p-[7px] xl:p-[8px] w-[12%]">
                        <Text
                          className="lg:my-[13px] xl:my-[16px] 2xl:my-[19px] 3xl:my-[22px] rowbrand"
                          variant="body9"
                        >
                          --
                        </Text>
                      ...
                      <Row className="bg-white_A700 items-center justify-between lg:p-[5px] xl:p-[7px] 2xl:p-[8px] 3xl:p-[9px] w-[7%]">
                        <Stack className="bg-gray_101 lg:h-[23px] xl:h-[28px] 2xl:h-[32px] 3xl:h-[38px] xl:my-[10px] 2xl:my-[12px] 3xl:my-[14px] lg:my-[8px] lg:px-[4px] xl:px-[5px] 2xl:px-[6px] 3xl:px-[7px] rounded-radius3 w-[35%]">
                          <Img
                            src="images/img_eye.svg"
                            className="absolute lg:h-[13px] xl:h-[17px] 2xl:h-[19px] 3xl:h-[22px] inset-[0] justify-center m-[auto] w-[57%]"
                            alt="eye"
                          />
                        </Stack>
                        <Stack className="bg-gray_101 lg:h-[23px] xl:h-[28px] 2xl:h-[32px] 3xl:h-[38px] mr-[4px] xl:my-[10px] 2xl:my-[12px] 3xl:my-[14px] lg:my-[8px] lg:px-[4px] xl:px-[5px] 2xl:px-[6px] 3xl:px-[7px] rounded-radius3 w-[35%]">
                          <Img
                  ...
                  <Line className="absolute bg-gray_201 bottom-[0] h-[1.12px] w-[100%]" />
                </Stack>
              </Stack>
              <Button
              ...
              >
                <div className="bg-transparent font-medium right-[0] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] lg:text-[9px] top-[0]">
                  任务取消成功
                </div>
              </Button>
            </Stack>
                ...
                <Column className="absolute items-center justify-start w-[100%]">
                  <Row className="items-center justify-evenly w-[100%]">
                    ...
                    <Column className="bg-white_A700 lg:p-[5px] xl:p-[7px] 2xl:p-[8px] 3xl:p-[9px] w-[12%]">
                      <Row className="bg-gray_101 items-center 2xl:my-[10px] 3xl:my-[12px] lg:my-[7px] xl:my-[8px] lg:p-[4px] xl:p-[5px] 2xl:p-[6px] 3xl:p-[7px] rounded-radius2 w-[39%]">

        ...
        <Column className="items-center justify-start w-[100%]">
          ...
          <Row className="font-alibabapuhuiti1 items-start justify-evenly w-[98%]">
            ...
            <Column className="font-pingfangsc justify-start w-[80%]">
              ...
              <Column className="justify-start lg:ml-[22px] xl:ml-[28px] 2xl:ml-[32px] 3xl:ml-[38px] lg:mt-[31px] xl:mt-[39px] 2xl:mt-[44px] 3xl:mt-[52px] w-[62%]">
                <Text
                ...
                <Row className="items-center lg:mt-[31px] xl:mt-[39px] 2xl:mt-[44px] 3xl:mt-[52px] rounded-radius4 w-[94%]">
                  <Text
                  ...
                  <Input
                    ...
                    wrapClassName="2xl:ml-[116px] 3xl:ml-[139px] lg:ml-[82px] w-[76%] xl:ml-[103px]"
                    name="Group251"
                    placeholder="吉利 V1.1"
                ...
                <Row className="items-start lg:mt-[29px] xl:mt-[37px] 2xl:mt-[42px] 3xl:mt-[50px] pt-[2px] w-[49%]">
                  <Text
                ...
                <Row className="items-center lg:mt-[29px] xl:mt-[37px] 2xl:mt-[42px] 3xl:mt-[50px] w-[94%]">
                  <Text
                    className="font-medium text-bluegray_500 w-[auto]"
                    variant="body8"
                  >
                  ...
                  <Row className="items-center justify-between lg:ml-[56px] xl:ml-[71px] 2xl:ml-[80px] 3xl:ml-[96px] w-[76%]">
                    <Input
                    ...
                    <Column className="bg-gray_54 items-center xl:p-[10px] 2xl:p-[12px] 3xl:p-[14px] lg:p-[8px] rounded-radius4 w-[19%]">
                      <Row className="items-center justify-center mb-[1px] w-[94%]">
                        <div className="bg-teal_400 rounded-radius50 plus_One"></div>
                        <Text className="rowellipsenine_two" variant="body8">
                          连接成功
                        </Text>
                      </Row>
                    </Column>
                ...
                <Row className="items-start lg:mt-[22px] xl:mt-[28px] 2xl:mt-[32px] 3xl:mt-[38px] w-[94%]">
                  <Text
                  ...
                  <Column className="bg-white_A700 border border-gray_300 border-solid items-center justify-start 3xl:ml-[110px] lg:ml-[65px] xl:ml-[81px] 2xl:ml-[92px] 2xl:p-[10px] 3xl:p-[12px] lg:p-[7px] xl:p-[8px] rounded-radius4 w-[76%]">
                    <List
                    ...
                    >
                      <Column className="listfivethousandninehundredtwentyfive">
                        <CheckBox
                          className="font-normal not-italic xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] lg:text-[9px] text-bluegray_800"
                          inputClassName="h-[16px] mr-[5px] w-[16px]"
                          name="FiveThousandNineHundredFiftySix"
                          label="感知"
                      ...
                      <Column className="listfivethousandninehundredtwentyfive">
                        <CheckBox
                          className="font-normal not-italic xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] lg:text-[9px] text-bluegray_800"
                          inputClassName="h-[16px] mr-[5px] w-[16px]"
                          name="FiveThousandNineHundredFiftySeven"
                          label="融合"
                          shape="RoundedBorder2"
                          size="sm"
                          variant="OutlineBluegray1001_2"
                      ...
                      <Column className="listfivethousandninehundredtwentyfive">
                        <CheckBox
                          className="font-normal not-italic xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] lg:text-[9px] text-bluegray_800"
                          inputClassName="h-[16px] mr-[5px] w-[16px]"
                          name="FiveThousandNineHundredFiftyEight"
                          label="规划"
                          shape="RoundedBorder2"
                          size="sm"
                          variant="OutlineBluegray1001_2"
                ...
                <Row className="items-start justify-between lg:mt-[22px] xl:mt-[28px] 2xl:mt-[32px] 3xl:mt-[38px] lg:pr-[27px] xl:pr-[34px] 2xl:pr-[39px] 3xl:pr-[46px] w-[100%]">
                  <Text
                  ...
                  <Column className="bg-white_A700 border border-gray_300 border-solid items-center justify-end lg:p-[4px] xl:p-[6px] 2xl:p-[7px] 3xl:p-[8px] rounded-radius4 w-[76%]">
                    <Column className="justify-start lg:mt-[5px] xl:mt-[7px] 2xl:mt-[8px] 3xl:mt-[9px] w-[98%]">
                      <Text
                        className="font-normal lg:leading-[18px] xl:leading-[23px] 2xl:leading-[26px] 3xl:leading-[31px] lg:mr-[5px] xl:mr-[7px] 2xl:mr-[8px] 3xl:mr-[9px] not-italic text-bluegray_800 w-[98%]"
                        variant="body8"
                      >
                        被测工控机为吉利V1.1 ，类型Cyber RT，基于Cyber
                        标准协议接入模块为感知和融合
                      </Text>
                      <Row className="items-center justify-end ml-[auto] lg:mt-[18px] xl:mt-[23px] 2xl:mt-[26px] 3xl:mt-[31px] w-[9%]">
                ...
                <Row className="items-center lg:mt-[22px] xl:mt-[28px] 2xl:mt-[32px] 3xl:mt-[38px] w-[94%]">
                  <Text
                    className="font-medium text-bluegray_500 w-[auto]"
                    variant="body8"
                  >
                  ...
                  <Input
                    className="placeholder:text-bluegray_800 Group251"
                    wrapClassName="2xl:ml-[64px] 3xl:ml-[76px] lg:ml-[45px] w-[76%] xl:ml-[56px]"
                    name="Group255"
                ...
                <Row className="items-center lg:ml-[110px] xl:ml-[138px] 2xl:ml-[156px] 3xl:ml-[187px] lg:mt-[25px] xl:mt-[32px] 2xl:mt-[36px] 3xl:mt-[43px] w-[20%]">
                  <Button

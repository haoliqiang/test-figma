              ...
              <Row className="items-center xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] lg:ml-[8px] w-[98%]">
                <Row className="items-center w-[13%]">
                  <Img
                    ...
                    alt="airplane"
                  />
                  <Text className="rowairplane" variant="body8">
                    自动驾驶安全验证平台
                  </Text>
                </Row>
                <Text
                  className="font-normal 2xl:ml-[106px] 3xl:ml-[127px] lg:ml-[75px] xl:ml-[94px] not-italic text-white_A700_a2 w-[auto]"
                  variant="body8"
                >
                  首页
                </Text>
                <Text
                  className="font-semibold lg:ml-[45px] xl:ml-[56px] 2xl:ml-[64px] 3xl:ml-[76px] text-white_A700 w-[auto]"
                  variant="body8"
                >
                  系统测试
                </Text>
                <Text
                  className="font-normal lg:ml-[45px] xl:ml-[56px] 2xl:ml-[64px] 3xl:ml-[76px] not-italic text-white_A700_a2 w-[auto]"
                  variant="body8"
                >
                  任务
                </Text>
                ...
                <Row className="items-start justify-center lg:ml-[327px] xl:ml-[409px] 2xl:ml-[460px] 3xl:ml-[552px] w-[7%]">
                  <Text
                    className="font-normal mt-[2px] not-italic text-white_A700 w-[auto]"
                    variant="body8"
                  >
                    Apollo-V5.5
                  </Text>
                ...
                <Row className="items-start justify-center lg:ml-[17px] xl:ml-[21px] 2xl:ml-[24px] 3xl:ml-[28px] w-[9%]">
                  ...
                  />
                  <Text
                    className="lg:ml-[4px] xl:ml-[6px] 2xl:ml-[7px] 3xl:ml-[8px] not-italic FiveHundredNinety"
                    variant="body8"
                  >
                    欢迎，王志杰
                  </Text>
                ...
                <Row className="items-center justify-between xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] lg:ml-[8px] lg:mt-[18px] xl:mt-[23px] 2xl:mt-[26px] 3xl:mt-[31px] w-[97%]">
                  <Row className="items-center justify-between w-[38%]">
                    <CheckBox
                      ...
                      name="SixThousandTwoHundredSixtySix"
                      label="全选"

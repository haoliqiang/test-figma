          ...
          <Stack className="3xl:h-[1081px] lg:h-[640px] xl:h-[801px] 2xl:h-[901px] w-[100%]">
            <Stack className="top-[7%] test_20220825">
              <Stack className="absolute lg:h-[114px] xl:h-[143px] 2xl:h-[161px] 3xl:h-[193px] right-[0] w-[87%]">
                <Img
                  src="images/img_image1_42.png"
                  className="imageOne"
                  alt="imageOne"
                />
                <Img
                  src="images/img_20220825_42.png"
            ...
            <Stack className="absolute bg-black_900_a2 3xl:h-[1081px] lg:h-[640px] xl:h-[801px] 2xl:h-[901px] lg:px-[145px] xl:px-[182px] 2xl:px-[205px] 3xl:px-[246px] w-[100%]">
              <Img
                src="images/img_vector_488X563.svg"
                className="absolute lg:h-[348px] xl:h-[435px] 2xl:h-[489px] 3xl:h-[586px] inset-[0] justify-center m-[auto] w-[39%]"
                alt="Vector"
              />
            </Stack>
          </Stack>

...
import I10rowNine from "components/Row/I10rowNine";
import I10rowFifteen from "components/Row/I10rowFifteen";
          ...
          <Row className="font-alibabapuhuiti1 items-center justify-evenly w-[99%]">
            ...
            <Column className="font-pingfangsc items-center w-[80%]">
              ...
              <Column className="font-alibabapuhuiti1 justify-start lg:mt-[17px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] w-[97%]">
                <Button
                  className="font-normal not-italic xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] lg:text-[9px] text-center w-[12%]"
                ...
                <div className="font-pingfangsc lg:mt-[12px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[20px] w-[100%]">
                  <Row className="bg-white_A700 items-center lg:pr-[12px] xl:pr-[15px] 2xl:pr-[17px] 3xl:pr-[20px] w-[100%]">
                    <Row className="items-center lg:pl-[5px] xl:pl-[7px] 2xl:pl-[8px] 3xl:pl-[9px] lg:py-[5px] xl:py-[7px] 2xl:py-[8px] 3xl:py-[9px] w-[10%]">
                      <Text
                    ...
                    <Row className="items-center justify-center lg:pl-[5px] xl:pl-[7px] 2xl:pl-[8px] 3xl:pl-[9px] lg:py-[5px] xl:py-[7px] 2xl:py-[8px] 3xl:py-[9px] w-[41%]">
                      <Text
                  ...
                  <Column className="items-center justify-start lg:mr-[12px] xl:mr-[15px] 2xl:mr-[17px] 3xl:mr-[20px] w-[98%]">
                    <Row className="bg-white_A700 items-center w-[100%]">
                      <Row className="items-center xl:p-[10px] 2xl:p-[12px] 3xl:p-[14px] lg:p-[8px] w-[10%]">
                        <Text
                          ...
                          <Row className="items-center justify-between w-[100%]">
                            <Row className="items-center justify-evenly w-[88%]">
                              <Column className="bg-white_A700 xl:pb-[10px] 2xl:pb-[12px] 3xl:pb-[14px] lg:pb-[8px] lg:pr-[4px] xl:pr-[6px] 2xl:pr-[7px] 3xl:pr-[8px] lg:pt-[4px] xl:pt-[6px] 2xl:pt-[7px] 3xl:pt-[8px] w-[37%]">
                                <Column className="justify-start lg:pt-[4px] xl:pt-[6px] 2xl:pt-[7px] 3xl:pt-[8px] w-[65%]">
                                  <Text
                                    className="rowfivethousandsixhundredthirtyeight"
                                    variant="body9"
                                  >
                      ...
                      <Row className="items-center lg:pr-[120px] xl:pr-[151px] 2xl:pr-[170px] 3xl:pr-[204px] w-[41%]">
                          ...
                          <Row className="items-center justify-between w-[100%]">
                            <Row className="items-center justify-evenly w-[88%]">
                              <Column className="bg-white_A700 xl:pb-[10px] 2xl:pb-[12px] 3xl:pb-[14px] lg:pb-[8px] lg:pr-[5px] xl:pr-[7px] 2xl:pr-[8px] 3xl:pr-[9px] lg:pt-[5px] xl:pt-[7px] 2xl:pt-[8px] 3xl:pt-[9px] w-[37%]">
                                <Column className="justify-start lg:pt-[5px] xl:pt-[7px] 2xl:pt-[8px] 3xl:pt-[9px] w-[65%]">
                                  <Text
                                    className="rowfivethousandsixhundredthirtyeight"
                                    variant="body9"
                                  >
                    ...
                    <I10rowNine className="bg-white_A700 items-center w-[100%]" />
                    <I10rowNine className="bg-white_A700 items-center w-[100%]" />
                    <I10rowNine className="bg-white_A700 items-center w-[100%]" />
                    <I10rowFifteen className="bg-white_A700 items-center w-[100%]" />
                    <I10rowFifteen className="bg-white_A700 items-center w-[100%]" />
                    <I10rowNine className="bg-white_A700 items-center w-[100%]" />
                    <Row className="bg-white_A700 items-center w-[100%]">
                      <Row className="items-center xl:p-[10px] 2xl:p-[12px] 3xl:p-[14px] lg:p-[8px] w-[10%]">
                      ...
                      <Row className="items-center xl:px-[10px] 2xl:px-[12px] 3xl:px-[14px] lg:px-[8px] w-[41%]">
                        <Column className="bg-white_A700 xl:pb-[10px] 2xl:pb-[12px] 3xl:pb-[14px] lg:pb-[8px] lg:pr-[5px] xl:pr-[7px] 2xl:pr-[8px] 3xl:pr-[9px] lg:pt-[5px] xl:pt-[7px] 2xl:pt-[8px] 3xl:pt-[9px] w-[83%]">
                          <Column className="justify-start lg:pt-[5px] xl:pt-[7px] 2xl:pt-[8px] 3xl:pt-[9px] w-[65%]">
                            <Text
                              className="rowfivethousandsixhundredthirtyeight"
                              variant="body9"

...
const Page14 = () => {
  return (
    <>
      <Stack className="bg-white_A700 font-pingfangsc lg:h-[2523px] xl:h-[3156px] 2xl:h-[3550px] 3xl:h-[4259px] mx-[auto] w-[100%]">
        <div className="absolute bottom-[0] inset-x-[0] mx-[auto] overflow-x-auto w-[98%]">
          <Row className="items-start justify-end overflow-auto w-[100%]">
            <Column className="justify-start w-[100%]">
              <Row className="items-center xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] lg:ml-[8px] w-[15%]">
                <CheckBox
                  ...
                  name="OneThousandEightHundredSeventyThree"
                  label="全选"
              ...
              <Column className="justify-start lg:mt-[18px] xl:mt-[23px] 2xl:mt-[26px] 3xl:mt-[31px] w-[100%]">
                ...
                <Row className="items-start justify-end lg:mt-[25px] xl:mt-[32px] 2xl:mt-[36px] 3xl:mt-[43px] w-[100%]">
                  <Stack className="lg:h-[1206px] xl:h-[1508px] 2xl:h-[1697px] 3xl:h-[2036px] w-[98%]">
                    <Column className="absolute bg-gray_54 items-center justify-end lg:p-[22px] xl:p-[28px] 2xl:p-[32px] 3xl:p-[38px] rounded-radius8 top-[1%] w-[100%]">
                      <Column className="items-center justify-start lg:mt-[45px] xl:mt-[56px] 2xl:mt-[64px] 3xl:mt-[76px] w-[100%]">
                        ...
                        <Column className="bg-white_A700 items-center justify-start lg:mt-[17px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] lg:p-[22px] xl:p-[28px] 2xl:p-[32px] 3xl:p-[38px] rounded-radius8 w-[100%]">
                          ...
                          <Column className="bg-white_A700 border border-gray_202 border-solid items-center justify-start lg:mt-[22px] xl:mt-[28px] 2xl:mt-[32px] 3xl:mt-[38px] lg:p-[22px] xl:p-[28px] 2xl:p-[32px] 3xl:p-[38px] rounded-bl-[0] rounded-br-[0] rounded-tl-[8px] rounded-tr-[8px] w-[100%]">
                            <Column className="justify-start lg:mb-[5px] xl:mb-[7px] 2xl:mb-[8px] 3xl:mb-[9px] lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[98%]">
                              <Row className="items-start w-[34%]">
                                <Text
                                  className="font-semibold mb-[1px] text-bluegray_800 w-[auto]"
                                  variant="body6"
                                >
                                  碰撞次数
                                </Text>
                                <Text
                                  className="mt-[4px] TwoHundredThree"
                                  variant="body9"
                                >
                                  碰撞车辆
                                </Text>
                              ...
                              <Row className="items-start justify-evenly lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] w-[100%]">
                                <Row className="items-end justify-between 3xl:mt-[10px] lg:mt-[6px] xl:mt-[8px] 2xl:mt-[9px] pt-[1px] rounded-radius1 w-[6%]">
                                  <Row className="items-start justify-between w-[61%]">
                                ...
                                <Column className="justify-start w-[94%]">
                                  <Column className="justify-start lg:ml-[191px] xl:ml-[239px] 2xl:ml-[269px] 3xl:ml-[322px] w-[75%]">
                                    <Row className="items-start justify-between w-[100%]">
                                      <Input
                                        className="w-[100%]"
                                        wrapClassName="2xl:h-[21px] 3xl:h-[25px] flex lg:h-[15px] w-[95%] xl:h-[18px]"
                                        name="OneThousandNineHundredTen"
                                        placeholder=""
                                        shape="RoundedBorder4"
                                        variant="FillAmber300"
                                      ></Input>
                                      <Text
                                        className="rowonethousandninehundredten"
                                        variant="body9"
                                      >
                                        200
                                      </Text>
                                    </Row>
                                    <Row className="items-start lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] w-[84%]">
                                      <div className="bg-bluegray_101 lg:h-[15px] xl:h-[18px] 2xl:h-[21px] 3xl:h-[25px] rounded-radius3 w-[94%]"></div>
                                      <Text
                                        className="rowonethousandninehundredeleven"
                                        variant="body9"
                                      >
                                        200
                                      </Text>
                                    ...
                                    <Text
                                      className="columnonethousandninehundredten"
                                      variant="body9"
                                    >
                                      碰撞行人
                                    </Text>
                                  </Column>
                                  <Row className="items-end lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] w-[64%]">
                                    <div className="bg-white_A700 xl:h-[2px] lg:h-[2px] 3xl:h-[3px] 2xl:h-[3px] lg:mb-[4px] xl:mb-[5px] 2xl:mb-[6px] 3xl:mb-[7px] 2xl:mt-[11px] 3xl:mt-[13px] lg:mt-[7px] xl:mt-[9px] rotate-[18deg] rounded-radius50 shadow-bs3 xl:w-[1px] lg:w-[1px] 3xl:w-[2px] 2xl:w-[2px]"></div>
                                    <Input
                                      className="w-[100%]"
                                      wrapClassName="2xl:h-[21px] 2xl:ml-[267px] 3xl:h-[25px] 3xl:ml-[320px] flex lg:h-[15px] lg:ml-[189px] w-[56%] xl:h-[18px] xl:ml-[237px]"
                                      name="OneThousandNineHundredTwelve"
                                      placeholder=""
                                      shape="RoundedBorder4"
                                      variant="FillCyan401"
                                    ></Input>
                                    <Text
                                      className="my-[3px] test_4517_One"
                                      variant="body9"
                                    >
                                      200
                                    </Text>
                              ...
                              <Row className="items-start lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] w-[79%]">
                                <Column className="justify-start 2xl:mt-[108px] 3xl:mt-[129px] lg:mt-[76px] xl:mt-[96px] w-[20%]">
                                  <Row className="items-center rounded-radius3 w-[70%]">
                                    <div className="bg-amber_300 2xl:h-[11px] 3xl:h-[13px] lg:h-[8px] xl:h-[9px] rounded-radius2 w-[3%]"></div>
                                    <Text
                                      className="rowtwenty_two"
                                      variant="body8"
                                    >
                                  ...
                                  <Row className="items-center lg:mt-[12px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[20px] rounded-radius3 w-[70%]">
                                    <div className="bg-cyan_401 2xl:h-[11px] 3xl:h-[13px] lg:h-[8px] xl:h-[9px] rounded-radius2 w-[3%]"></div>
                                    <Text
                                      className="rowtwenty_two"
                                      variant="body8"
                                    >
                                  ...
                                  <Row className="items-center lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] rounded-radius3 w-[100%]">
                                    <div className="bg-indigo_A100 2xl:h-[11px] 3xl:h-[13px] lg:h-[8px] xl:h-[9px] rounded-radius2 w-[2%]"></div>
                                    <Text
                                      className="rowtwenty_two"
                                      variant="body8"
                                    >
                                ...
                                <Column className="justify-start lg:mb-[34px] xl:mb-[43px] 2xl:mb-[49px] 3xl:mb-[58px] lg:ml-[113px] xl:ml-[142px] 2xl:ml-[160px] 3xl:ml-[192px] w-[62%]">
                                  <Row className="items-start justify-between w-[100%]">
                                    <div className="bg-bluegray_101 lg:h-[15px] xl:h-[18px] 2xl:h-[21px] 3xl:h-[25px] rounded-radius3 w-[93%]"></div>
                                    <Text
                                      className="rowonethousandninehundredten"
                                      variant="body9"
                                    >
                                  ...
                                  <Row className="items-start lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] w-[84%]">
                                    <Input
                                      className="w-[100%]"
                                      wrapClassName="2xl:h-[21px] 3xl:h-[25px] flex lg:h-[15px] w-[92%] xl:h-[18px]"
                                      name="OneThousandNineHundredSeventeen"
                                      placeholder=""
                                      shape="RoundedBorder4"
                                      variant="FillIndigoA100"
                                    ></Input>
                                    <Text
                                      className="rowonethousandninehundredeleven"
                                      variant="body9"
                                  ...
                                  <Row className="items-start justify-between lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] w-[100%]">
                                    <div className="bg-bluegray_101 lg:h-[15px] xl:h-[18px] 2xl:h-[21px] 3xl:h-[25px] rounded-radius3 w-[93%]"></div>
                                    <Text
                                      className="rowonethousandninehundredten"
                                      variant="body9"
                              ...
                              <Text
                                className="lg:ml-[244px] xl:ml-[306px] 2xl:ml-[344px] 3xl:ml-[413px] FiveHundredFiftyThree"
                                variant="body9"
                              >
                                碰撞其他物体
                              </Text>
                              <Row className="items-start mt-[2px] w-[94%]">
                                <Row className="items-center rounded-radius3 w-[14%]">
                                  <div className="bg-deep_orange_400 2xl:h-[11px] 3xl:h-[13px] lg:h-[8px] xl:h-[9px] rounded-radius2 w-[3%]"></div>
                                  <Text
                                    className="rowtwenty_two"
                                    variant="body8"
                                  >
                                ...
                                <Input
                                  className="w-[100%]"
                                  wrapClassName="2xl:h-[21px] 2xl:ml-[188px] 3xl:h-[25px] 3xl:ml-[225px] flex lg:h-[15px] lg:ml-[133px] mt-[3px] w-[65%] xl:h-[18px] xl:ml-[167px]"
                                  name="OneThousandNineHundredTwenty"
                                  placeholder=""
                                  shape="RoundedBorder4"
                                  variant="FillDeeporange400"
                                ></Input>
                                <Text
                                  className="lg:mt-[4px] xl:mt-[6px] 2xl:mt-[7px] 3xl:mt-[8px] test_4517_One"
                                  variant="body9"
                                >
                                  200
                                </Text>
                              </Row>
                              <Row className="items-center lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] w-[85%]">
                                <Row className="items-center rounded-radius3 w-[10%]">
                                  <div className="bg-bluegray_101 2xl:h-[11px] 3xl:h-[13px] lg:h-[8px] xl:h-[9px] rounded-radius2 w-[4%]"></div>
                                  <Text
                                    className="rowtwenty_two"
                                    variant="body8"
                                  >
                                ...
                                <Row className="items-start justify-between lg:ml-[173px] xl:ml-[217px] 2xl:ml-[244px] 3xl:ml-[292px] w-[65%]">
                                  <div className="bg-bluegray_101 lg:h-[15px] xl:h-[18px] 2xl:h-[21px] 3xl:h-[25px] rounded-radius3 w-[94%]"></div>
                                  <Text
                                    className="rowonethousandninehundredten"
                                    variant="body9"
                    ...
                    <Row className="absolute bg-gray_54 items-center xl:p-[12px] 2xl:p-[14px] 3xl:p-[16px] lg:p-[9px] rounded-bl-[0] rounded-br-[0] rounded-tl-[8px] rounded-tr-[8px] top-[0] w-[100%]">
                      <Row className="items-start lg:ml-[12px] xl:ml-[15px] 2xl:ml-[17px] 3xl:ml-[20px] lg:mt-[12px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[20px] w-[95%]">
                        <Text
                        ...
                        <Row className="items-start justify-center lg:ml-[27px] xl:ml-[33px] 2xl:ml-[38px] 3xl:ml-[45px] mt-[1px] rounded-radius1 w-[7%]">
                          <Text className="B" as="h1" variant="h1">
                            B
                          </Text>
                          <Text
                            className="OneThousandNineHundredTwentyFour"
                            variant="body4"
                          >
                            级
                          </Text>
                          <Img
                            src="images/img_signal_1.svg"
                            className="signal2"
                            alt="signal"
                          />
                        </Row>
                        <Column className="items-center justify-start lg:ml-[415px] xl:ml-[519px] 2xl:ml-[584px] 3xl:ml-[701px] rounded-radius4 w-[25%]">
                ...
                <Img
                  ...
                  className="xl:h-[3px] lg:h-[3px] 3xl:h-[4px] 2xl:h-[4px] lg:ml-[242px] xl:ml-[303px] 2xl:ml-[341px] 3xl:ml-[409px] lg:mt-[2228px] xl:mt-[2787px] 2xl:mt-[3136px] 3xl:mt-[3762px] w-[4px]"
                  alt="126deg"
                />
                <Img
                  src="images/img_126deg.svg"
            ...
            <Img
              src="images/img_270deg_7.png"
              className="xl:h-[1px] lg:h-[1px] 3xl:h-[2px] 2xl:h-[2px] lg:ml-[1878px] xl:ml-[2350px] 2xl:ml-[2643px] 3xl:ml-[3172px] lg:mt-[1467px] xl:mt-[1835px] 2xl:mt-[2064px] 3xl:mt-[2477px] rotate-[90deg] w-[5px]"
              alt="270deg"
            />
            <Img
              src="images/img_270deg_8.png"
              className="xl:h-[1px] lg:h-[1px] 3xl:h-[2px] 2xl:h-[2px] lg:ml-[23px] xl:ml-[29px] 2xl:ml-[33px] 3xl:ml-[39px] lg:mt-[1467px] xl:mt-[1835px] 2xl:mt-[2064px] 3xl:mt-[2477px] rotate-[90deg] w-[5px]"
              alt="270deg One"
            />
          </Row>
        </div>
        <Column className="absolute items-center justify-start top-[0] w-[100%]">
          ...
          <Column className="items-center justify-start w-[100%]">
            <Stack className="lg:h-[114px] xl:h-[143px] 2xl:h-[161px] 3xl:h-[193px] w-[100%]">
              <Stack className="test_20220825">
                <Stack className="absolute lg:h-[114px] xl:h-[143px] 2xl:h-[161px] 3xl:h-[193px] right-[0] w-[87%]">
                  <Img
                    src="images/img_image1_21.png"
                    className="imageOne"
                    alt="imageOne"
                  />
                  <Img
                    src="images/img_20220825_21.png"
            ...
            <Row className="items-start lg:mt-[29px] xl:mt-[36px] 2xl:mt-[41px] 3xl:mt-[49px] w-[93%]">
              <Text
                className="font-semibold mt-[2px] text-bluegray_800 w-[auto]"
                variant="body4"
              >
                测试结果
              </Text>
              <Stack className="lg:h-[12px] xl:h-[15px] 2xl:h-[17px] 3xl:h-[20px] 2xl:ml-[10px] 3xl:ml-[12px] lg:ml-[7px] xl:ml-[8px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] w-[7%]">
              ...
              <Column className="items-center justify-start 3xl:ml-[1054px] lg:ml-[624px] xl:ml-[781px] 2xl:ml-[878px] w-[20%]">
                <List
                  className="lg:gap-[22px] xl:gap-[28px] 2xl:gap-[31px] 3xl:gap-[37px] grid grid-cols-[repeat(2,_1fr_2px)_1fr] min-h-[auto] xl:pl-[12px] 2xl:pl-[14px] 3xl:pl-[16px] lg:pl-[9px] w-[100%]"
                  orientation="horizontal"
                >
                  <Column className="justify-start w-[100%]">
                    <Row className="items-end w-[74%]">
                    ...
                    <Row className="items-center justify-evenly mt-[4px] w-[100%]">
        ...
        <Stack className="absolute lg:h-[483px] xl:h-[604px] 2xl:h-[679px] 3xl:h-[815px] inset-x-[0] mx-[auto] top-[27%] w-[96%]">
          ...
          <Stack className="absolute lg:h-[483px] xl:h-[604px] 2xl:h-[679px] 3xl:h-[815px] w-[100%]">
            <Stack className="absolute lg:h-[483px] xl:h-[604px] 2xl:h-[679px] 3xl:h-[815px] w-[100%]">
              <Stack className="absolute lg:h-[483px] xl:h-[604px] 2xl:h-[679px] 3xl:h-[815px] w-[100%]">
                <Stack className="absolute lg:h-[483px] xl:h-[604px] 2xl:h-[679px] 3xl:h-[815px] w-[100%]">
                  <Stack className="absolute lg:h-[437px] xl:h-[547px] 2xl:h-[615px] 3xl:h-[738px] top-[0] w-[100%]">
                    <Stack className="absolute lg:h-[437px] xl:h-[547px] 2xl:h-[615px] 3xl:h-[738px] w-[100%]">
                      <Column className="absolute justify-start w-[100%]">
                        <Stack className="lg:h-[345px] xl:h-[432px] 2xl:h-[486px] 3xl:h-[583px] w-[100%]">
                          <Stack className="absolute lg:h-[300px] xl:h-[375px] 2xl:h-[422px] 3xl:h-[506px] top-[0] w-[100%]">
                            <Stack className="absolute lg:h-[300px] xl:h-[375px] 2xl:h-[422px] 3xl:h-[506px] w-[100%]">
                              <Stack className="absolute lg:h-[300px] xl:h-[375px] 2xl:h-[422px] 3xl:h-[506px] w-[100%]">
                                <Stack className="absolute lg:h-[254px] xl:h-[318px] 2xl:h-[358px] 3xl:h-[429px] top-[0] w-[100%]">
                                          ...
                                          <Column className="justify-start w-[100%]">
                                            <Row className="items-start lg:ml-[34px] xl:ml-[42px] 2xl:ml-[48px] 3xl:ml-[57px] w-[86%]">
                                              ...
                                              <Img
                                                ...
                                                alt="Vector"
                                              />
                                              <Row className="items-start justify-center xl:ml-[103px] 2xl:ml-[116px] 3xl:ml-[139px] lg:ml-[82px] w-[5%]">
                                                <Text
                                ...
                                <Line className="absolute bg-gray_202 h-[1px] top-[23%] w-[100%]" />
                                <Line className="absolute bg-gray_202 bottom-[16%] h-[1px] w-[100%]" />
                                <Row className="absolute items-center justify-center right-[25%] top-[14%] w-[20%]">
                                  <Text className="rowbrand" variant="body9">
                                    2020-09-09 21:00:02
                                  </Text>
                                  <Text
                                    className="xl:ml-[102px] 2xl:ml-[115px] 3xl:ml-[138px] lg:ml-[81px] rowbrand"
                                    variant="body9"
                                  >
                                    00:40
                                  </Text>
                                </Row>
                                <Row className="absolute bottom-[23%] items-center justify-center right-[25%] w-[20%]">
                                  <Text className="rowbrand" variant="body9">
                                    2020-09-09 21:00:02
                                  </Text>
                                  <Text
                                ...
                                <Column className="absolute bg-white_A700 items-center justify-start left-[0] xl:p-[10px] 2xl:p-[12px] 3xl:p-[14px] lg:p-[8px] top-[23%] w-[3%]">
                                  <div className="border border-gray_402 border-solid xl:my-[10px] 2xl:my-[12px] 3xl:my-[14px] lg:my-[8px] rounded-radius2 arrowleft"></div>
                                </Column>
                                ...
                                <Column className="absolute bg-white_A700 justify-start left-[3%] lg:p-[5px] xl:p-[7px] 2xl:p-[8px] 3xl:p-[9px] top-[23%] w-[26%]">
                          ...
                          <Line className="absolute bg-gray_202 h-[1px] top-[33%] w-[100%]" />
                          <Line className="absolute bg-gray_202 bottom-[14%] h-[1px] w-[100%]" />
                          <Text
                            className="absolute right-[36%] top-[25%] rowbrand"
                            variant="body9"
                          >
                            2020-09-09 21:00:02
                          </Text>
                          <Text
                            className="absolute bottom-[20%] right-[36%] rowbrand"
                            variant="body9"
                          >
                            2020-09-09 21:00:02
                          </Text>
                          <Column className="absolute bg-white_A700 items-center justify-start left-[0] xl:p-[10px] 2xl:p-[12px] 3xl:p-[14px] lg:p-[8px] top-[33%] w-[3%]">
                            <div className="border border-gray_402 border-solid xl:my-[10px] 2xl:my-[12px] 3xl:my-[14px] lg:my-[8px] rounded-radius2 arrowleft"></div>
                          </Column>
                          <Column className="absolute bg-white_A700 bottom-[1%] items-center justify-start left-[0] xl:p-[10px] 2xl:p-[12px] 3xl:p-[14px] lg:p-[8px] w-[3%]">
                            <div className="border border-gray_402 border-solid xl:my-[10px] 2xl:my-[12px] 3xl:my-[14px] lg:my-[8px] rounded-radius2 arrowleft"></div>
                          </Column>
                          <Column className="absolute bg-white_A700 justify-start left-[3%] lg:p-[5px] xl:p-[7px] 2xl:p-[8px] 3xl:p-[9px] top-[33%] w-[26%]">
                  ...
                  <Line className="absolute bg-gray_202 h-[1px] top-[33%] w-[100%]" />
                  <Line className="absolute bg-gray_202 bottom-[29%] h-[1px] w-[100%]" />
                  <Line className="absolute bg-gray_202 bottom-[10%] h-[1px] w-[100%]" />
                  <Text
                    className="absolute right-[36%] top-[27%] rowbrand"
                    variant="body9"
                  >
                    2020-09-09 21:00:02
                  </Text>
                  <Column className="absolute h-[max-content] inset-y-[0] justify-start left-[3%] my-[auto] w-[68%]">
                  ...
                  <Text
                    className="absolute bottom-[14%] right-[36%] rowbrand"
                    variant="body9"
                  >
                    2020-09-09 21:00:02
                  </Text>
                  ...
                  <Column className="absolute bg-white_A700 bottom-[20%] items-center justify-start left-[0] xl:p-[10px] 2xl:p-[12px] 3xl:p-[14px] lg:p-[8px] w-[3%]">
                    <div className="border border-gray_402 border-solid xl:my-[10px] 2xl:my-[12px] 3xl:my-[14px] lg:my-[8px] rounded-radius2 arrowleft"></div>
                  </Column>
                  <Column className="absolute bg-white_A700 bottom-[1%] items-center justify-start left-[0] xl:p-[10px] 2xl:p-[12px] 3xl:p-[14px] lg:p-[8px] w-[3%]">
                    <div className="border border-gray_402 border-solid xl:my-[10px] 2xl:my-[12px] 3xl:my-[14px] lg:my-[8px] rounded-radius2 arrowleft"></div>
                  </Column>
                  <Row className="absolute bottom-[19%] items-start left-[3%] w-[51%]">
                    <Column className="bg-white_A700 justify-start lg:p-[5px] xl:p-[7px] 2xl:p-[8px] 3xl:p-[9px] w-[51%]">
                      <Row className="items-end 3xl:mb-[10px] lg:mb-[6px] xl:mb-[8px] 2xl:mb-[9px] mt-[4px] rounded-radius4 w-[46%]">
                        <Column
                          className="bg-cover bg-repeat lg:h-[29px] xl:h-[36px] 2xl:h-[41px] 3xl:h-[49px] items-center justify-start rounded-radius4 lg:w-[28px] xl:w-[35px] 2xl:w-[40px] 3xl:w-[48px]"
                          style={{
                    ...
                    <Column className="bg-white_A700 justify-start lg:p-[5px] xl:p-[7px] 2xl:p-[8px] 3xl:p-[9px] w-[12%]">
                      <Text className="columnu12302" variant="body9">
                        已完成
                      </Text>
                    </Column>
                    <Column className="bg-white_A700 justify-end lg:p-[17px] xl:p-[21px] 2xl:p-[24px] 3xl:p-[28px] w-[36%]">
                      <Text className="columnone12" variant="body9">
                        压线1次
                      </Text>
                    </Column>
                ...
                <Column className="absolute bottom-[1%] justify-start right-[19%] w-[23%]">
                  <Column className="bg-white_A700 justify-start lg:ml-[102px] xl:ml-[128px] 2xl:ml-[144px] 3xl:ml-[172px] lg:p-[17px] xl:p-[22px] 2xl:p-[25px] 3xl:p-[30px] w-[55%]">
                    <Text className="columntime_one" variant="body9">
                      1:22:23
                    </Text>
                  </Column>
                  <Column className="items-center justify-start xl:mr-[120px] 2xl:mr-[136px] 3xl:mr-[163px] lg:mr-[96px] lg:mt-[136px] xl:mt-[170px] 2xl:mt-[192px] 3xl:mt-[230px] w-[57%]">
                    <div className="bg-white_A700 lg:h-[46px] xl:h-[57px] 2xl:h-[65px] 3xl:h-[77px] w-[100%]"></div>
                    <div className="bg-white_A700 lg:h-[46px] xl:h-[57px] 2xl:h-[65px] 3xl:h-[77px] lg:mt-[46px] xl:mt-[57px] 2xl:mt-[65px] 3xl:mt-[78px] w-[100%]"></div>
                  </Column>
                </Column>
              </Stack>
              <Column className="absolute bottom-[1%] items-center justify-start right-[19%] w-[13%]">
              ...
              <Line className="absolute bg-gray_202 h-[1px] top-[42%] w-[100%]" />
            </Stack>
            <Line className="absolute bg-gray_202 bottom-[20%] h-[1px] w-[100%]" />
            <Line className="absolute bg-gray_202 bottom-[1%] h-[1px] w-[100%]" />
            <Text
              className="absolute right-[36%] top-[37%] rowbrand"
              variant="body9"
            >
              2020-09-09 21:00:02
            </Text>
            <Column className="absolute bottom-[22%] items-end justify-start right-[10%] w-[35%]">
            ...
            <Column className="absolute bottom-[3%] items-end justify-start right-[10%] w-[35%]">
              <Button
                className="flex lg:h-[20px] xl:h-[25px] 2xl:h-[29px] 3xl:h-[34px] items-center justify-center lg:w-[19px] xl:w-[24px] 2xl:w-[28px] 3xl:w-[33px]"
                shape="icbRoundedBorder3"
                size="mdIcn"
            ...
            <Column className="absolute items-center justify-start right-[10%] top-[7%] w-[2%]">
              <Button
                className="flex lg:h-[20px] xl:h-[25px] 2xl:h-[29px] 3xl:h-[34px] items-center justify-center w-[100%]"
                shape="icbRoundedBorder3"
                size="mdIcn"
            ...
            <Column
              className="absolute bg-cover bg-repeat items-center justify-end lg:py-[14px] xl:py-[17px] 2xl:py-[20px] 3xl:py-[24px] right-[34%] top-[3%] w-[22%]"
            ...
            >
              <Column className="justify-start lg:mt-[3px] xl:mt-[4px] 2xl:mt-[5px] 3xl:mt-[6px] w-[100%]">
                <CheckBox
                  className="font-normal xl:ml-[12px] 2xl:ml-[14px] 3xl:ml-[16px] lg:ml-[9px] not-italic xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[8px] text-gray_905"
                  inputClassName="h-[16px] mr-[5px] w-[16px]"
                  name="OneThousandNineHundredSeventy"
                  label="全选"
                  shape="RoundedBorder2"
                  size="sm"
                  variant="OutlineGray402"
                ></CheckBox>
                <Column className="justify-end lg:mt-[11px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] xl:pt-[12px] 2xl:pt-[14px] 3xl:pt-[16px] lg:pt-[9px] xl:px-[12px] 2xl:px-[14px] 3xl:px-[16px] lg:px-[9px] w-[100%]">
                  <Row className="items-center mr-[auto] mt-[3px] w-[32%]">
                    <Stack className="bg-blue_A401 rounded-radius2 arrowleft">
                      <Img
                    ...
                    <Text
                      className="2xl:ml-[11px] 3xl:ml-[13px] lg:ml-[7px] xl:ml-[9px] columnu1230"
                      variant="body9"
                    >
                      只看无事故
                    </Text>
                  ...
                  <CheckBox
                    className="font-normal lg:mt-[23px] xl:mt-[29px] 2xl:mt-[33px] 3xl:mt-[39px] not-italic xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[8px] text-gray_905"
                    inputClassName="h-[16px] mr-[5px] w-[16px]"
                    name="OneThousandNineHundredSeventyTwo"
                    label="只看有事故"
                    shape="RoundedBorder2"
                    size="sm"
                    variant="OutlineGray402"
                  ></CheckBox>
                  <List
                    className="gap-[0] min-h-[auto] lg:ml-[19px] xl:ml-[24px] 2xl:ml-[27px] 3xl:ml-[32px] lg:mt-[23px] xl:mt-[29px] 2xl:mt-[33px] 3xl:mt-[39px] w-[82%]"
                    orientation="vertical"
                  >
                    <Row className="listonethousandeighthundredsixtyseven">
                      <CheckBox
                        ...
                        inputClassName="h-[16px] mr-[5px] w-[16px]"
                        name="OneThousandEightHundredSixtySeven"
                        label="撞车"
                        shape="RoundedBorder2"
                        size="sm"
                        variant="OutlineGray402"
                      ...
                      <CheckBox
                        className="font-normal not-italic xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[8px] text-gray_905"
                        inputClassName="h-[16px] mr-[5px] w-[16px]"
                        name="OneThousandEightHundredSixtyEight"
                        label="撞车"
                        shape="RoundedBorder2"
                        size="sm"
                        variant="OutlineGray402"
                      ...
                      <CheckBox
                        className="font-normal not-italic xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[8px] text-gray_905"
                        inputClassName="h-[16px] mr-[5px] w-[16px]"
                        name="OneThousandEightHundredSixtyNine"
                        label="逆行"
                        shape="RoundedBorder2"
                        size="sm"
                        variant="OutlineGray402"
                    ...
                    <Line className="self-center w-[100%] h-[1px] bg-gray_202" />
                    <Row className="listonethousandeighthundredsixtyseven">
                      <CheckBox
                        className="font-normal not-italic xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[8px] text-gray_905"
                        inputClassName="h-[16px] mr-[5px] w-[16px]"
                        name="OneThousandEightHundredSeventy"
                        label="压线"
                        shape="RoundedBorder2"
                        size="sm"
                        variant="OutlineGray402"
                      ...
                      <CheckBox
                        className="font-normal not-italic xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[8px] text-gray_905"
                        inputClassName="h-[16px] mr-[5px] w-[16px]"
                        name="OneThousandEightHundredSeventyOne"
                        label="撞车"
                        shape="RoundedBorder2"
                        size="sm"
                        variant="OutlineGray402"
                      ...
                      <CheckBox
                        className="font-normal not-italic xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[8px] text-gray_905"
                        inputClassName="h-[16px] mr-[5px] w-[16px]"
                        name="OneThousandEightHundredSeventyTwo"
                        label="逆行"
                        shape="RoundedBorder2"
                        size="sm"
                        variant="OutlineGray402"
                  ...
                  <CheckBox
                    className="font-normal lg:ml-[19px] xl:ml-[24px] 2xl:ml-[27px] 3xl:ml-[32px] lg:mt-[11px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] not-italic xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[8px] text-gray_905"
                    inputClassName="h-[16px] mr-[5px] w-[16px]"
                    name="OneThousandNineHundredSeventyThree"
                    label="逆行"
                    shape="RoundedBorder2"
                    size="sm"
                    variant="OutlineGray402"
        ...
        <Line className="absolute bg-bluegray_200 lg:h-[57px] xl:h-[72px] 2xl:h-[81px] 3xl:h-[97px] right-[1%] rounded-radius2 top-[28%] w-[4px]" />
      </Stack>
    </>
  );
};

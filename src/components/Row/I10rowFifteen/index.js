...
import { Row, Line, Text, Stack, Column, Button, Img } from "components";

const I10rowFifteen = (props) => {
  return (
    <>
      <Row className={props.className}>
        <Row className="items-center xl:p-[10px] 2xl:p-[12px] 3xl:p-[14px] lg:p-[8px] w-[10%]">
          <Text className="rownine_nine" variant="body9">
            Apollo V4.0
          </Text>
        </Row>
        <Row className="items-center justify-evenly w-[100%]">
          <Stack className="lg:h-[46px] xl:h-[57px] 2xl:h-[65px] 3xl:h-[77px] xl:pl-[10px] 2xl:pl-[12px] 3xl:pl-[14px] lg:pl-[8px] w-[100%]">
            <Column className="absolute items-center justify-start w-[99%]">
              <Row className="items-center justify-between w-[100%]">
                <Row className="items-center justify-evenly w-[88%]">
                  ...
                  <Column className="bg-white_A700 lg:py-[17px] xl:py-[21px] 2xl:py-[24px] 3xl:py-[28px] w-[18%]">
                    <Text
                      className="columnfivethousandeighthundredninetysix"
                      variant="body9"
                    >
                      连接成功
                    </Text>
            ...
            <Button
              className="absolute flex lg:h-[20px] xl:h-[25px] 2xl:h-[29px] 3xl:h-[34px] inset-y-[0] items-center justify-center my-[auto] right-[10%] lg:w-[19px] xl:w-[24px] 2xl:w-[28px] 3xl:w-[33px]"
              shape="icbRoundedBorder3"
              size="mdIcn"
              variant="icbFillGray54"
            >

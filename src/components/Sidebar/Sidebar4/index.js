        ...
        <div className="">
          <Row className="items-start w-[100%]">
            <Column className="bg-white_A700 items-center justify-start xl:p-[10px] 2xl:p-[12px] 3xl:p-[14px] lg:p-[8px] w-[100%]">
              ...
              <Row className="bg-white_A700 items-center justify-center lg:mb-[316px] xl:mb-[395px] 2xl:mb-[445px] 3xl:mb-[534px] xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] lg:mt-[8px] 2xl:p-[10px] 3xl:p-[12px] lg:p-[7px] xl:p-[8px] rounded-radius4 w-[91%]">
                <Stack
                  className="bg-cover bg-repeat computer"
                  style={{ backgroundImage: "url('images/img_car_3.svg')" }}
                >
            ...
            <Line className="bg-gray_101 2xl:h-[1003px] 3xl:h-[1204px] lg:h-[713px] xl:h-[892px] w-[1px]" />
          </Row>
        </div>
      </aside>
    </>

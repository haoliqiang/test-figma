      ...
      <header className={props.className}>
        <Row className="bg-blue_A401 items-center lg:p-[14px] xl:p-[17px] 2xl:p-[20px] 3xl:p-[24px] w-[100%]">
          <Row className="items-center xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] lg:ml-[8px] w-[98%]">
            ...
            <Text
              className="3xl:ml-[105px] lg:ml-[62px] xl:ml-[78px] 2xl:ml-[88px] text-white_A700_a2 rowthreethousandsixhundredsixtysix"
              variant="body8"
            >
              首页
            </Text>
            ...
            <Row className="items-start justify-center lg:ml-[230px] xl:ml-[288px] 2xl:ml-[324px] 3xl:ml-[389px] w-[7%]">
